...
def diiid_case_D(surface_potential = 1000, charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
      setup_case(Zi = 1, amu_i = 2, charge_i = 1,
                 Zb = 1, amu_b = 2, charge_b = 1,
                 Ti = Tii, ni = n,
                 Te = Tee, ne = n,
...
def diiid_case_C(surface_potential = 1000, charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
      setup_case(Zi = 6, amu_i = 14, charge_i = 1,
                 Zb = 1, amu_b = 2, charge_b = 1,
                 Ti = Tii, ni = n,
                 Te = Tee, ne = n,
                 Bmag = btot, phi = 180/np.pi*(np.pi-theta),
