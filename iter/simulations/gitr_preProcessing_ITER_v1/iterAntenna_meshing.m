...
yields_total=readmatrix('yields_total_all_species.txt');
density_total=readmatrix('density_total_all_species.txt');
flow_total=readmatrix('flow_total_all_species.txt');
erosion_flux_total=readmatrix('flux_total_all_species.txt');
...
surf_fields=table(centroid_x, centroid_y, centroid_z, potential_surf, density_total, flow_total, yields_total, erosion_flux_total);
