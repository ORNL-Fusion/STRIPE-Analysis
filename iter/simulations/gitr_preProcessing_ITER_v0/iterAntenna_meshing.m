...
figure;
patch(transpose(X),transpose(Y),transpose(Z),ne_surf(plotSet),'FaceAlpha',1,'EdgeAlpha', 0.3 );
...
figure; 
patch(transpose(X),transpose(Y),transpose(Z),potential_surf(plotSet),'FaceAlpha',1,'EdgeAlpha', 0.3 )
