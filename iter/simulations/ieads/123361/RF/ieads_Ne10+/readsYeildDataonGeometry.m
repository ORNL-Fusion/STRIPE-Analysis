...
data=readmatrix('Targets_Ne10+.txt');
yields_data=readmatrix('yields_Ne10+.csv');
...
patch(transpose(X),transpose(Y),transpose(Z),[0;yields_data(:,10)],'FaceAlpha',1,'EdgeAlpha', 0.3)%,impacts(surface)
title('Yields')
