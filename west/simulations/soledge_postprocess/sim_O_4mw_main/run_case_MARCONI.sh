...
export GLI_HOME=$WORK/libs/libs_gateway/gks
...
# Executable
EXECDIR=$HOME/Codes/S3XE/build # !!! CHANGE HERE!!!
...
S3XDIR=$HOME/Codes/S3XE/soledge3x # !!! CHANGE HERE!!!
STYXDIR=$HOME/Codes/S3XE/styx  # !!! CHANGE HERE!!!
...
# Launch the job
################
time srun --mpi=pmi2 -K1 $SRUN_CPU_BIND_OPTIONS $EXECDIR/$EXECNAME $PETSC_OPTIONS
