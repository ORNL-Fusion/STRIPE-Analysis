...
def setup_case(Zi = 1, amu_i = 2, charge_i = 1,
    ...
    vzz[:] = vz
    rootgrp.close()
def west_thermal_O(charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
     phi_angle = theta;
     print('phi_angle',phi_angle)
     setup_case(Zi = 8, amu_i = 16, charge_i = charge,
             Zb = 1, amu_b = 2, charge_b = 1,
                Ti = Tii, ni = n,
                Te = Tee, ne = n,
                Bmag = btot, phi = 180/np.pi*(np.pi-theta),
                nP = 1e4, nT = 5e5, dt = 1.0e-10,height_factor = 5*sheath_factor,
                filename = "input/gitrInput.cfg")
def west_rf_O(surface_potential = 1000, charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
       setup_case(Zi = 8, amu_i = 16, charge_i = charge,
                  Zb = 1, amu_b = 2, charge_b = 1,
                  Ti = Tii, ni = n,
                  Te = Tee, ne = n,
                  Bmag = btot, phi = 180/np.pi*(np.pi-theta),
                  niP = 1e4, nT = 5e4, dt = 5.0e-9,height_factor = 5*sheath_factor,
                  filename = "input/gitrInput.cfg")
       ...
       with io.open('input/gitrInput.cfg', 'w') as f:
            libconf.dump(config, f) 
def west_rf_B(surface_potential = 1000, charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
       setup_case(Zi = 5, amu_i = 11, charge_i = charge,
                  Zb = 1, amu_b = 2, charge_b = 1,
                  Ti = Tii, ni = n,
                  Te = Tee, ne = n,
                  Bmag = btot, phi = 180/np.pi*(np.pi-theta),
       ...
       with io.open('input/gitrInput.cfg', 'w') as f:
            libconf.dump(config, f) 
def west_rf_C(surface_potential = 1000, charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
       setup_case(Zi = 6, amu_i = 14, charge_i = charge,
                  Zb = 1, amu_b = 2, charge_b = 1,
                  Ti = Tii, ni = n,
                  Te = Tee, ne = n,
                  Bmag = btot, phi = 180/np.pi*(np.pi-theta),
...
def ProtoMPEx_case_O(surface_potential = 1000, T=4, n=5e18, sheath_factor = 1.0):
    ...
    with io.open('input/gitrInput.cfg', 'w') as f:
        libconf.dump(config, f)
def d3d_case_C(charge = 1, Tee=4, Tii = 3, n=5e18,btot = 1,theta=0, sheath_factor = 1.0):
    phi_angle = theta;
    print('phi_angle',phi_angle)
    setup_case(Zi = 8, amu_i = 16, charge_i = charge,
            Zb = 2, amu_b = 2, charge_b = 1,
               Ti = Tii, ni = n,
               Te = Tee, ne = n,
               Bmag = btot, phi = theta,
               nP = 1e4, nT = 2e4, dt = 1.0e-9,height_factor = 5*sheath_factor,
               filename = "input/gitrInput.cfg")
