...
for i in range(0, 13743):
    for j in range(6,7):
        ...
        impacts.west_rf_O(surface_potential = surface_potential, charge = 666666, Tee=te, Tii = ti, n=ni,btot = btot,theta=theta, sheath_factor = 1.0)
        ...
        subprocess.run("~/myRepos/GITR/build/./GITR", shell=True, check=True)
        #subprocess.run("/home/atul_ornl/myRepos/gitr_new/build/GITR", shell=True, check=True)
