% Created by JF Caneses, 2017_07_23
% Ne and Te database

% v3
% In the previous version (v2) we completed the data gathering for the period
% 2016_11_28 to 2016_11_15. Once this was completed we proceeded to code up
% for the following period: 2016_12_19 to 2017_07_07
...
switch state
    case 1 % Load data
        ...
        % #################################################################
        % Period 2016_11_28 to 2016_11_15
        % Load previously calculated Ne and Te
        % load('NeTe_2016_07_28_to_2016_11_15.mat')
        % #################################################################
        % Period 2016_12_190 to 2017_07_07
        % Load previously calculated Ne and Te
        load('NeTe_2016_12_19_to_2017_07_07')
        % #################################################################        
...
if LoadDLPinfo
    D = importdata('DLPinfo_2016_12_19_to_2017_07_07.xlsx','',1);
...
% Save data:
if SaveAllData
   save('NeTe_2016_12_19_to_2017_07_07')
elseif SaveDLPinfo
    load('NeTe_2016_12_19_to_2017_07_07','ni','Ni','Te','time','Ifit','Ip',...
