...
if fetchDataFromServer
    % Radial scan:
    % =====================================================================
%     shotlist =  [31000 + [800,801,802,803,804,805,806,807]];
%     r        =           [0  ,1  ,2  ,3  ,4  ,5  ,5.5,6.0] ;
%     arr      =           ['D','D','D','D','D','D','D','D'] ;
    
    % 180 degree test 1:
    shotlist =  [31000 + [811,812,813,814]];
    r        =           [8.0,8.0,8.0,8.0] ;
    arr      =           ['D','T','T','D'] ;
    
    % 180 degree test 2:
    shotlist =  [31000 + [815,816]];
    r        =           [3.0,3.0] ;
    arr      =           ['D','T'] ;
    ...
    % Single shot preview:
%     shotlist =  [31000 + [800,801,802,803,804,805,806,807,808,809,810,811]];
%     r        =           [0  ,1  ,2  ,3  ,4  ,5  ,5.5,6.0,6.5,7.0,7.5,8.0] ;
%     arr      =           ['D','D','D','D','D','D','D','D','D','D','D','D'] ;
...
for ii = 1:numel(shotlist)
    ...
    V_BDOT_TANG{ii} = S1{ii}/att6;
    V_BDOT_NORM{ii} = S2{ii}/att6;
end
