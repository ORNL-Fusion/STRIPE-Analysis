...
switch ShotType
    case 1
        shotlist = [30000 + [95],29690]; 
        shotlist = [29000 + [721:736]]; 
        shotlist = [30000 + [102],29721]; 
        shotlist = [30000 + [65],29721]; 
        shotlist = [30000 + [65,110,114]]; 
        shotlist = [30000 + [142],29070]; 

     case 2  %  high density shots at 70 kW
        shotlist = [29000 + [721:725]];
    case 3 % Plasma density during Bdot probe scan at spool 2.5
        shotlist = [30000 + [148:150]];
        shotlist = [30000 + [151]];
        shotlist = [30000 + [150,151,153,154]];
        shotlist = [30000 + [154,156,157]];
        shotlist = [30000 + [168]];
end
