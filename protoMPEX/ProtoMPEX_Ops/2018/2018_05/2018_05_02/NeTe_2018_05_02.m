...
% =========================================================================
% 2018_05_02
% turbo pump experiments
shotlist = 21000 + [842,843,845,846,848,849];
dt       =         [3  ,3  ,3  ,2  ,2  ,1  ];

shotlist = 21000 + [842,849,853];
shotlist = 21000 + [842,854,855,856,857,858];
shotlist = 21000 + [842,858,859,860];

shotlist = 21000 + [874];

% turning pumps OFF systematically
shotlist = 21000 + [845,846,849];
shotlist = 21000 + [845,846];

% % PG6.5 is oscillating harmonically in these shots:
% % shotlist = 21000 + [849:854];
% % =========================================================================
% % Optmized fueling with ALL pumps ON
% shotlist = 21000 + [845,863];
% % =========================================================================\
% % All pumps ON, optimized versus early PUFF
