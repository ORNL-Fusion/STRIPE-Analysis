...
% =========================================================================
    ...
    MetaData.shot = 21000 + [742,746,747,748,826,828];
    MetaData.dt   =         [3.5,3.5,5  ,5  ,5  ,6.5];
    % Best shots for neutral gas are (1) 21742 and (5) 21826
    % Best shots for DLP         are (2) 21746 and (4) 21748

    MetaData.DataSetDescription     = ['Systematically changed the gas flow level, 2018_05_01'];
    %--------------------------------------------------------------------------------------------------------------------------------------
    % Define ADDRESSES
    Address.V   =        {aV{1}};
    Address.I   =        {aI{2}};
