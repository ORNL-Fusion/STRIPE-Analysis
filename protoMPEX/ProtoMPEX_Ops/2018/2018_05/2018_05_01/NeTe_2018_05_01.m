...
shotlist = 21000 + [742,746,747,748,826,828];
dt       =         [3.5,3.5,5  ,5  ,5  ,6.5];
...
%     plot(time{s}(GoodFits{s}),ni{s}{2}(GoodFits{s}),C{s},'lineWidth',1);
    ...
    h(s) = plot(t_Ni_gf{s},sqrt(1.6)*Ni_gf{s},C{s},'lineWidth',2);
...
for s = 1:length(shotlist)
        ...
        h(s) = plot(t_Te_gf{s},(0.625)*Te_gf{s},C{s},'lineWidth',2);
