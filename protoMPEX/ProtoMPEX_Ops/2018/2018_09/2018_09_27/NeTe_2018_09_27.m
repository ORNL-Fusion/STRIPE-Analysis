...
% - Puffer at spool 1.5
%   - PS1/2 = 2200/3500 A
shotlist = [22900 + [52,53]];
RFpower  =          [7 ,10] ;

% - Increased PS1/2 to 4500 A produce ne ~ 5e19 m-3
shotlist = [22900 + [52,53,54]];
RFpower  =          [7 ,10,10] ;

% - At the PS1/2 = 4500 A level we reduced the gas puff
shotlist = [22900 + [54:56]];

DLPType = '12MP';

% 2018_10_01
shotlist = [23000 + [138,139,140,141]];
