...
shotlist = 22400 + [93,117:121];
shotlist = 22400 + [93,122,123,124,125,126];
DLPType = '12MP';

% Start of RF power scan
shotlist  = 22400 + [126,127,128,129,130,133,136];
RFvoltage =         [ 10,  9,  8,  7,  6,  5,  4];

% RF power scan, List from Cornwall:
shotlist  = 22400 + [138,137,133,140,141,142,143,144];
RFvoltage =         [4.1,4.3,  5,  6,  7,  8,  9, 10];
DLPType = '12MP';

% % shotlist  = 22400 + [ 93,136,137,138,139];
% shotlist  = 22400 + [140,141,142,143,144];
% RFvoltage =         [ 6 ,  7,  8,  9, 10];
% DLPType = '12MP';
% 
% shotlist  = 22400 + [145,146];
% DLPType = '10MP';
% 
% shotlist  = 22400 + [144,147,148];
% DLPType = '12MP';
