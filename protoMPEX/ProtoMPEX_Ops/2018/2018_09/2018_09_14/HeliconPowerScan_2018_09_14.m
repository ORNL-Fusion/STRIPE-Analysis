...
DownloadData = 0;
SaveData = 0;
DataName = 'HeliconPowerScan_2018_09_05_RawData';
...
% =========================================================================
    ...
    MetaData.shot         =    [22538 ,22537 , 22533, 22540, 22541, 22542, 22543, 22544];
    MetaData.RFVoltage    =    [4.1   ,4.3   , 5.0  , 6.0  ,   7.0,   8.0,   9.0   10.0] ;
    MetaData.DataSetDescription     = ['Helicon power scan using 28 GHz ECH experiments '];
    %--------------------------------------------------------------------------------------------------------------------------------------
    % Define ADDRESSES
    Address.V   =        {aV{1}};
    Address.I   =        {aI{1}};
...
RFVoltage = RawData.MetaData.RFVoltage;
