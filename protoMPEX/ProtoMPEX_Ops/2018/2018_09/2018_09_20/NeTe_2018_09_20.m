...
% #########################################################################
% DLP 1.5 shots
shotlist = [22700 + [44,47,48,62,72,77]];

% DLP 1.5 glowing
% shotlist = [22700 + [104]];

% spool 1.5 fueling
shotlist = [22700 + [115,116]];

% 2018_09_19, DLP 1.5 radial scan
shotlist = [22700 + [0:10,12]];

% Example of DLP 1.5 response
shotlist = [22000 + [686:687,691]];

% Oher examples showing increase in ne
shotlist = [22000 + [699:701]];

% Other examples
shotlist = [22000 + [703:705]];

% Comparing core and edge
% shotlist = [22000 + [705,706]];

% More examples:
shotlist = [22000 + [706:710]];

% Radial scan
shotlist = [22000 + [718,706,708,709,710,714,715,716]];
r        = [        [0.0,0.5,1.0,1.5,2.0,2.5,3.0,3.5]];

% DLP 1.5 response on-axis:
shotlist = [22000 + [718:722]];
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.3 & Ni{s}>0 & Ni{s}<30e19 & Te{s}<=20 & Is{s}>0.01e-3;
