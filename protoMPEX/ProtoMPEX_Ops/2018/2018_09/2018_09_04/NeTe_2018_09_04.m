...
shotlist = 22300 + [64,65,66];
shotlist = 22300 + [55,66,67,68,69,70,71];
shotlist = 22300 + [55,70,72];
shotlist = 22300 + [55,72,73,74,75,76,77];
shotlist = 22300 + [55,77,78,79,80,81,82];
shotlist = 22300 + [55,82,83,84,85,86];
shotlist = 22300 + [55,88,90,91,92,93,94];
shotlist = 22300 + [55,94,95,96];
shotlist = 22300 + [95,96,97,98];
DLPType = '12MP';

shotlist = 22300 + [99,100,101];
DLPType = '1MP';

% Begin PS1 scan
shotlist = 22300 + [99  ,100 ,101 ,104 ];
PS1      =         [2800,2800,2800,2900];

shotlist = 22300 + [166];
DLPType = '12MP';

% PS2 scan 
shotlist = [22493,22503,22504,22507,22511];
PS2      = [3500 ,3200 ,2900 ,2600 ,3800 ];
PS1      = [2200 ,2200 ,2200 ,2200 ,2200 ];
DLPType = '12MP';
