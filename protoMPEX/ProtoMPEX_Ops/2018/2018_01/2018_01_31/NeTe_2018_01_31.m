...
% =========================================================================
shotlist = [19000 + [474,475,505]];
shotlist = [19000 + [527:532,534,536]];
shotlist = [19000 + [521,537:538]];
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.3 & Ni{s}>0 & Ni{s}<1e21 & Te{s}<=30;
