...
% =========================================================================
% First few shots on 201_01_05
shotlist = [18000 + [833,834,835,845,849]];
shotlist = 18000 + [994,995,996,997,998,999,1000,1001,1002]; 
shotlist = 18000 + [998,999,1000,1001,1002,1003,1004,1005,1007,1008,1010]; 
shotlist = 18000 + [1010,1011,1012,1033,1034,1035,1036,1037]; 
shotlist = 18000 + [1033,1034,1035,1036,1037,1040,1041]; 
shotlist = 18000 + [1033,1042,1043,1044,1045,1046,1047,1048,1049,1050,1051]; 
PS1      =         [4.5 ,4.5 ,4.2 ,3.9 ,3.6 ,3.3 ,3.0 ,2.7 ,2.4 ,2.1 ,1.8 ];

% % shotlist = 18000 + [1047,1052,1053]; 
% shotlist = [19000 + [220,221,222,223,224,225]];
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.1 & Ni{s}>0 & Ni{s}<1e21 & Te{s}<=20;
...
h(p) = errorbar(PS1(b)*1000,ne{p}(b),dne{p}(b))
end
h(1).Color = 'k';
h(2).Color = 'r';
h(3).Color = 'g';
...
for p = 4
h(p) = errorbar(PS1(b)*1000,Te{p}(b),dTe{p}(b),'LineWidth',1)
end
h(1).Color = 'k';
h(2).Color = 'r';
h(3).Color = 'g';
