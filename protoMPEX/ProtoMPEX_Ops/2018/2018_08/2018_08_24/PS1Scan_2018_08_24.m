...
DownloadData = 0;
SaveData = 0;
DataName = 'PS1Scan_2018_08_24_RawData';
...
% =========================================================================
    ...
    MetaData.shot         =    [22221 ,22212 , 22214, 22216, 22223, 22224] ;
    MetaData.PS1          =    [1500  , 2500 , 3500 , 4500 ,  5500,  6000] ;
    MetaData.PS2          =    [2500  , 2500 , 2500 , 2500 ,  2500,  2500] ;
    MetaData.TR2          =    [120   , 120  , 120  , 120  ,  120 ,  120 ] ;
    MetaData.DataSetDescription     = ['PS1 scan, helicon plasma only'];
    %--------------------------------------------------------------------------------------------------------------------------------------
    % Define ADDRESSES
    Address.V   =        {aV{1}};
    Address.I   =        {aI{1}};
...
%% Plot steady-state part for density
close all
...
h(1) = errorbar(PS1*1e-3,ne0,dne0)
h(1).Color = 'k'
...
h(3) = errorbar(PS1*1e-3,Te0,dTe0)
h(3).Color = 'k'
...
h(5) = errorbar(PS1*1e-3,e_c*ne0.*Te0,e_c*dne0.*dTe0)
h(5).Color = 'k'
