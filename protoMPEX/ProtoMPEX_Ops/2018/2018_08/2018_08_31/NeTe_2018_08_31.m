...
shotlist = 22000 + [272,273,278,279];
shotlist = 22000 + [284];
DLPType = '12MP';

% DLP 1.5, PS1 field scan
shotlist = 22000 + [289,290,291,292,293,294,295,296,297,298,299,300,301,302,303,304,305]; 
PS1      =         [4.5,4.3,4.1,3.9,3.7,3.5,3.3,3.1,2.9,2.7,2.5,4.7,4.9,5.1,5.3,5.5,5.7]; % kA
DLPType = '1MP';

% DLP 12.5, gas fueling optimization
shotlist = 22000 + [306,307,308,309]; 
DLPType = '12MP';

% no plasma, gas only, gas fueling optimization
shotlist = 22000 + [310,311,312,313,315]; 
shotlist = 22000 + [309,319,320,321,322,323,324]; 
shotlist = 22000 + [324,325,326,327]; 
shotlist = 22000 + [328,329,330,331,332]; 
% DLPType = '12MP';
% 
% % DLP 12.5, increase PS2 to 3500 A
% shotlist = 22000 + [334,335,336,339,340]; 
% DLPType = '12MP';
% 
% % DLP 12.5, ECH power scan (downwards)
% shotlist = 22000 + [342,343,344,345,346,347]; 
% DLPType = '12MP';
% 
% % DLP 12.5, ECH power scan (upwards)
% shotlist = 22000 + [348,349,350,351,353,354]; 
% DLPType = '12MP';
% 
% % DLP 12.5, Reduce gas flow to improve discharge
% shotlist = 22000 + [354,355]; 
% DLPType = '12MP';
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.2 & Ni{s}>0 & Ni{s}<20e19 & Te{s}<=20 & Is{s}>0.01e-3;
