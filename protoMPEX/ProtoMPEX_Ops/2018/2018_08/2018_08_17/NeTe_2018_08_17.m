...
switch ProbeLoc
    case 'A'
% #########################################################################
shotlist = 21000 + [934:938]; 

shotlist = 21000 + [939,940]; 

shotlist = 21000 + [934:941];

shotlist = 21000 + [946]; 
shotlist = 21000 + [951,954]; 

shotlist = 21000 + [944,967,970,971]

% 2018_08_16
shotlist = 22000 + [0,1,2];
% 1st DLP shot at 100 kW
shotlist = 22000 + [3,5,6,7];
% PS2 = 3000 and 4500, PS1 = 3000, TR1/2 = 600, 160
shotlist = 22000 + [6,7,10,12,14];
shotlist = 22000 + [15,16,17];

%Correct DLP connections
shotlist = 22000 + [19];
% Increased PS1 to 4500 A, 
shotlist = 22000 + [19,20,22,23];

% Possible self-emission on DLP
% shotlist = 22000 + [10];

% DLP 1.5
shotlist = 22000 + [26,27,28,39];
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.2 & Ni{s}>0 & Ni{s}<10e19 & Te{s}<=20 & Is{s}>0.01e-3;
