...
% #########################################################################
% 2018_12_21
shotlist = 25000 + [334,335,336]; SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
shotlist = 25000 + [339,340]; SweepType = 'iso'  ;AttType = 'Vx1,Ix1';

% Start of the ICH flow experiments
% DLP 12.5
shotlist = 25000 + [359,360,362 ,363 ,364  ,365 ,366 ]; 
R        =         [9.5,9.0,10.0,9.25,10.25,10.5,11];
% shot from above series but no ICH
% shotlist = 25000 + [361 ,362 ]; 
% R        =         [10.0,10.0];
DLPType = '12MP';

% DLP 8.5
shotlist = 25000 + [368,369 ,370 ,371 ,374, 376,  377 ,378 ,379 ,380 ]; 
R        =         [13 ,13.5,14.0,14.5, 15, 15.5, 16.5,13.5,13.0,12.0];

% Rotating probe 180 deg
% shotlist = 25000 + [371 ,373 ]; 
% R        =         [14.5,14.5];

% shotlist =25000 + [379,380];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '8MP';

% DLP 6.5 scan
shotlist = 25000 + [381 ,383 ]; 
R        =         [10.0,10.0];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
shotlist = 25000 + [384 ,385 ,386,387,388,389,391 ]; 
R        =         [10.0,10.5,9.5,9.0,8.5,8.0,11.0];
% Rotate the probe 180 degrees
shotlist = 25000 + [391,392]
SweepType = 'niso'  ;AttType = 'Vx1,Ix5';
DLPType = '6MP';
...
% Start of ECH flow experiments
% DLP 12.5
shotlist = 25000 + [397 ,399,400];
R        =         [9.5 ,9.5,9.5];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '12MP';

% DLP 8.5
shotlist = 25000 + [402 ,403 ];
R        =         [14.5,14.5];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '8MP';

% DLP 6.5
shotlist = 25000 + [404 ,405];
R        =         [11  ,11 ];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '6MP';

% DLP 1.5
shotlist = 25000 + [406 ,407 ,408 ];
R        =         [10.5,10.5,10.5];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '1MP';

% DLP 6.5: Downhill configuration
shotlist = 25000 + [409 ];
R        =         [11  ];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '6MP'

% DLP 8.5: Downhill configuration
shotlist = 25000 + [410 ,411,412,413];
R        =         [14  ,14 ,14 ,14 ];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '6MP'

% DLP 12.5: Downhill configuration
shotlist = 25000 + [414];
R        =         [9.5];
SweepType = 'iso'  ;AttType = 'Vx1,Ix1';
DLPType = '12MP'
