...
shotlist = 25000 + [378];
% 180 degree probe rotation
shotlist = 25000 + [371,373];
shotlist = 25000 + [385];
% 180 degree DLP 6.5 probe rotation
...
% ECH effect,DLP 6.5
shotlist = 25000 + [404];
% ECH effect,DLP 6.5, downhill configuration
shotlist = 25000 + [409];
% ECH effect,DLP 8.5, downhill configuration
shotlist = 25000 + [410,411,412,413];
% ECH effect,DLP 12.5, downhill configuration
% shotlist = 25000 + [413];
...
%     Select data range:
    MPI_1{s} = sgolay_t(f_1{s}(rng),3,11);
    MPI_2{s} = sgolay_t(f_2{s}(rng),3,11);
    t1{s} = tf1{1}(rng);
    t2{s} = tf2{1}(rng);
