...
% #########################################################################
% 2018_12_07
shotlist = 24000 + [876,877,878,881];
% shotlist = 24000 + [876,882];
 DLPType = '12MP';
% 
% shotlist = 24000 + [884,885,886];
% shotlist = 24000 + [887,888,890,892,893,894];
% R        =         [0  ,1  ,1.5,2.0,2.5,3.0];
% DLPType = '1MP';
% 
% shotlist = 24000 + [895,896 ,897,898 ,899 ];
% R        =         [10 ,10.5,11 ,11.5,11.5];
% shotlist = 24000 + [899,900,901,902];
% PS1      =         [2.3,2.8,2.8];
% PS2      =         [4.5,4.5,3.0];
% shotlist = 24000 + [903,905,906,907];
% PWR_RF   =         [5.0,5.0,6.0,5.5];
% shotlist = 24000 + [910,913];
% DLPType = '8MP';
% 
% shotlist = 24000 + [917,918,919];
% shotlist = 24000 + [919,920,921,922,923];
% shotlist = 24000 + [922,923,924];
% % All systems on
% shotlist = 24000 + [922,923];
% % ECH only
% % shotlist = 24000 + [925];
% % ICH only
% % shotlist = 24000 + [926,928];
% DLPType = '1MP';
% 
