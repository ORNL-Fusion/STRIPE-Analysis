...
% #########################################################################
% 2018_12_13
shotlist = 25000 + [76:78];
shotlist = 25000 + [81,82,86,87];
shotlist = 25000 + [89,92];
shotlist = 25000 + [95,96]
% with ECH only
shotlist = 25000 + [97:100]
DLPType = '12MP';

% DLP 8.5 with ECH
shotlist = 25000 + [101,102,103]
DLPType = '8MP';

% DLP 6.5 + MachProbe with ECH
shotlist = 25000 + [104,105,108]
shotlist = 25000 + [111,112,114]
shotlist = 25000 + [114,115]
DLPType = '6MP';

% with ICH only
% shotlist = 25000 + [120]
shotlist = 25000 + [129]; SweepType = 'iso';AttType = 'Vx1,Ix1'
% shotlist = 25000 + [133]; SweepType = 'niso'   ;AttType = 'Vx1,Ix1'
% shotlist = 25000 + [134]; SweepType = 'niso'   ;AttType = 'Vx1,Ix2'
shotlist = 25000 + [134,135,136,137,138]; SweepType = 'niso'  ;AttType = 'Vx1,Ix2'
shotlist = 25000 + [140]; SweepType = 'niso'  ;AttType = 'Vx1,Ix2'
shotlist = 25000 + [141,142,143]; SweepType = 'niso'  ;AttType = 'Vx1,Ix5'
DLPType = '12MP';
...
if 1
    ...
    errorbar(R,nes{n},dnes{n},'ko')
    ylim([0,5e19])
    
    subplot(2,1,2); hold on
    errorbar(R,Tes{n},dTes{n},'ko')
    ylim([0,6])
end
