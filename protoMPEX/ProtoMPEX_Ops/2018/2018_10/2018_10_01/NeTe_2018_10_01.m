...
% DLP 12.5 shots 
% Start of the day
shotlist = [23100 + [7,8,10]];
% Gas puff effect
shotlist = [23100 + [10,13]];
% Gas puff effect at the ECH
shotlist = [23100 + [10,19:23]];
shotlist = [23100 + [10,18:20,24]];
shotlist = [23100 + [25:37]];

shotlist = [23100 + [10,24,29]];
shotlist = [23100 + [97,98,99,100,101],22991];
shotlist = [23100 + [101,102,103:108],22991];
shotlist = [23100 + [109]];

% shotlist = [23100 + [18:25]];
DLPType = '12MP';

shotlist = [23100 + [110]];
DLPType = '1MP';

shotlist = [23100 + [113,116,120]];
DLPType = '10MP';

shotlist = [23100 + [097,121:122,124]];
DLPType = '12MP';
% #########################################################################
