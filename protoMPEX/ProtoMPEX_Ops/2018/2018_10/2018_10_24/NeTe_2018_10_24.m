...
% #########################################################################
% 2018_10_14
shotlist = 23800 + [18,20,21,22,23,24,25,26];
% Reduce the 2nd puff to improve differential pumping
shotlist = 23800 + [26,27,28,29,30];
shotlist = 23800 + [30,31,32,35,36,41,42];
shotlist = 23800 + [44,45,46,47];
% ECH pulses in
% shotlist = 23800 + [64,65,66];
% shotlist = 23800 + [69,70,74];
DLPType = '12MP';
