...
% #########################################################################
% DLP 12.5 shots 
shotlist = [23100 + [131,132,133,137,138]];
shotlist = [23100 + [138,139,140,141,145,148]];
shotlist = [23100 + [151,152,153,155]];
shotlist = [23100 + [155,156,157]];
shotlist = [23100 + [157,161]];
shotlist = [23100 + [157,161,163]];

shotlist = [23100 + [157,161,163,166]];
shotlist = [23100 + [173:174]];
shotlist = [23100 + [179,188]];

% PS2 scan
shotlist = [23100 + [194,195,196,197,198]];

% PS2 scan with ECH
shotlist = [23000 + [301,302,303,304,305:308]];

DLPType = '12MP';

% DLP 1.5 
shotlist = [23000 + [311,312]];
DLPType = '1MP';

% 2018_10_10
shotlist = [23000 + [329,332]];
DLPType = '12MP';
