...
% #########################################################################
% 2018_11_02
shotlist = 24000 + [174,175,176,177];
DLPType = '12MP';

% % Use DLP 8.5 and scan field
% shotlist = 24000 + [178,179,180];
% % increase gas flow 2nd puff
% shotlist = 24000 + [180,183,188,189,190,191];
% shotlist = 24000 + [190:194];
% % Increase PS2 to 4500 A
% shotlist = 24000 + [194,195,197,199,200,201];
% 
% shotlist = 24000 + [183,217,218,221,224,225,226];
% shotlist = 24000 + [224,225,226,227];
% shotlist = 24000 + [199,226,227,228,230,231];
% shotlist = 24000 + [200,231,233,234,235,237];
% shotlist = 24000 + [234,235,237,239,240,241,242];
shotlist = 24000 + [233,234,235]
shotlist = 24000 + [240]
DLPType = '8MP';
% 
% % Lowering TR2
% shotlist = 24000 + [249,251];
% DLPType = '12MP';
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.04 & Ni{s}>0 & Ni{s}<30e19 & Te{s}<=20 & Is{s}>0.01e-3;
