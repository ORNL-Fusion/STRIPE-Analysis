...
% 2018_11_08
% Increases TR2
shotlist = 24000 + [279,281];
% Increased PS3
shotlist = 24000 + [279,281,282,283];
% Increased 2nd puff
shotlist = 24000 + [283,284,285];

% Start a rough radial scan
shotlist = 24000 + [285,286 ,288,289  ,290 ,292];
r        =         [9.5,9.75,10 ,10.25,9.25,9.0];
DLPType = '12MP';
% 
% Change to DLP 8.5
shotlist = 24000 + [293,294,295,296,297];
DLPType = '8MP';
% Increase PS2
shotlist = 24000 + [295,298];
DLPType = '8MP';
% Increase TR2
shotlist = 24000 + [298,300];
% Increase PS1
shotlist = 24000 + [300,302,303,304,305];
shotlist = 24000 + [305,306,307,308];
shotlist = 24000 + [309,310,311,312,313];
shotlist = 24000 + [313,314,315,316,317,318];
shotlist = 24000 + [318,320,321];
% Reduce RF power
shotlist = 24000 + [321,322];
DLPType = '8MP';

% Change to DLP 12.5
% Reduce RF power
shotlist = 24000 + [323,324,325,328,329];
shotlist = 24000 + [329,330];
DLPType = '12MP';
