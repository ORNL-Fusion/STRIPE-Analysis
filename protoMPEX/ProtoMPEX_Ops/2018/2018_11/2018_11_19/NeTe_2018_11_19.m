...
DLPType = '12MP';
% % DLP 8.5
shotlist = 24000 + [448,450,453,454,455];
shotlist = 24000 + [454,456];
DLPType = '8MP';
shotlist = 24000 + [457,462,463];
shotlist = 24000 + [460,462,463,465,467];
% increase PS1 to 8000 A
shotlist = 24000 + [467,468,469,470,471];
shotlist = 24000 + [471,472,473];
% REduce PSq to 4500 A
shotlist = 24000 + [475];
DLPType = '12MP';
% Change to DLP 8.5
shotlist = 24000 + [478,480,481,483];
DLPType = '8MP';
% #########################################################################
