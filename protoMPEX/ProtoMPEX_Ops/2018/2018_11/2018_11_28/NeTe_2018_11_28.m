...
% #########################################################################
% 2018_11_28
shotlist = 24000 + [558,559,560,561,562];
shotlist = 24000 + [564,565,566,567,568,569];
shotlist = 24000 + [570,571,572,573];
shotlist = 24000 + [577,578,579];
shotlist = 24000 + [579];
shotlist = 24000 + [584];
...
%     plot(t_ech{s}(1:length(ECH{s})),abs(ECH{s})*1e19,C{s},'lineWidth',0.5)
     ...
     plot(t_ICH_F{s}(1:length(ICH_F{s})),(ICH_F{s}.^2)*50e19,C{s},'lineWidth',1.5)
     plot(t_ICH_R{s}(1:length(ICH_R{s})),(ICH_R{s}.^2)*50e19,C{s},'lineWidth',1.5)
