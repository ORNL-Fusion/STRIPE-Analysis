...
% Change to DLP 8.5
% PS3 scan
shotlist = 24000 + [408,409,410];
% Increase PS1 to increase density
shotlist = 24000 + [410,411,412,413,414];
shotlist = 24000 + [413,414,415,416];
shotlist = 24000 + [410,413,416,417];
DLPType = '8MP';
% DLP 1.5
shotlist = 24000 + [418,419,420];
DLPType = '1MP';
% % DLP 12.5
% shotlist = 24000 + [421,422,423,424];
% shotlist = 24000 + [414,431,433];
% shotlist = 24000 + [434,435,436,437];
% shotlist = 24000 + [447];
% DLPType = '12MP';
% % % DLP 8.5
% shotlist = 24000 + [443];
