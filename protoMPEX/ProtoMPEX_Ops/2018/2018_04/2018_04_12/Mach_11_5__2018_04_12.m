% Mach probe radial scan on spool 9.5, 2018-04-15
...
shotlist = [21000 + [121,122 ,123 ,128 ,130 ,131 ,132 ,133 ,134 ,135  ,136  ,138 ]];
Rad      =          [14 ,14.5,15.0,15.5,16.0,16.5,17.0,17.5,15.5,15.75,16.25,16.0] ;

% shotlist = [21000 + [128 ,130 ,131 ,132 ,134 ,135  ,136  ]];
% Rad      =          [15.5,16.0,16.5,17.0,15.5,15.75,16.25] ;
% 
% shotlist = [21000 + [123 ,128 ,130 ,131 ,134 ,135  ,136  ,132 ]];
% Rad      =          [15.0,15.5,16.0,16.5,15.5,15.75,16.25,17.0] ;

% shotlist = [21000 + [122]]% very little flow and Isat is symmetric 
% shotlist = [21000 + [133 ]]% Isat is symmetric 
% 
% shotlist = [21000 + [132 ]]% Isat is symmetric 
% Rad      =          [17.0]

shotlist = [21000 + [140,141,142,143 ,144,145,146,147,148,149,150,151 ,153 ,154 ]];
Rad      =          [9  ,9  ,9.5,9.25,9.0,8.5,8.0,7.5,7.0,6.5,6.0,7.75,8.25,10.0] 
