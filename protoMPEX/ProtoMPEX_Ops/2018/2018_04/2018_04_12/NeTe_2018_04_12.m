...
% =========================================================================
% 2018_04_12
shotlist = [21000 + [116,117]];
% DLP 9.5 radial scan
shotlist = [21000 + [121,122 ,123 ,128 ,130 ,131 ,132 ,133 ,134 ,135  ,136  ]];
R        =          [14 ,14.5,15.0,15.5,16.0,16.5,17.0,17.5,15.5,15.75,16.25] ;

% shotlist = [21000 + [121,137 ]];
% R        =          [14 ,13.5] ;

% Remove droop on DLPs:
% shotlist = [21000 + [130,138,139]];
% R        =          [16 ,16 ,16 ] ;

% Gas pressure w/ and w/o plasma:
% shotlist = [21000 + [112,116]];
% shotlist = [21000 + [162,163]];

% =========================================================================
% Effect of low pass filters
% shotlist = [21000 + [123,124,125,126,127]];
% R        =          [20 ,10 ,1  ,1.1,1  ] ;

% DLP 11.5 radial scan, target z = 7cm
shotlist = [21000 + [140,141,142,143 ,144,145]];
R        =          [9  ,9  ,9.5,9.25,9.0,8.5] ;
% 
shotlist = [21000 + [144,145,146,147,148,149,150,151 ,153 ,154 ]];
R        =          [9.0,8.5,8.0,7.5,7.0,6.5,6.0,7.75,8.25,10.0] ;

shotlist = [21000 + [140,141,142,143 ,144,145,146,147,148,149,150,151 ,153 ,154 ]];
R        =          [9  ,9  ,9.5,9.25,9.0,8.5,8.0,7.5,7.0,6.5,6.0,7.75,8.25,10.0] ;

% Effect of increasing the bias
% shotlist = [21000 + [151 ,152]];
% R        =          [7.75,7.75] ;

% Target locatio scan
% TR2 = 180 A, PS1 = 5800, PS2 = 6000 A
% shotlist = [21000 + [156,157,158]];
% R        =          [7.5,7.5,8.5] ;
% Target_z =          [7.0,7.0,7.0] ;
% 
shotlist = [21000 + [158,159,160,161,163,164,165 ,166,167 ,168,169 ,170,171 ,172]];
R        =          [8.5,8.5,8.5,8.5,8.5,8.5,8.5 ,8.5,8.5 ,8.5,8.5 ,8.5,8.5 ,8.5] ;
Target_z =          [7.0,6.0,5.0,4.0,3.0,2.0,1.75,1.5,1.25,1.0,0.75,0.5,0.25,0.0] ;
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.13 & Ni{s}>0 & Ni{s}<15e19 & Te{s}<=8 & Is{s}>1e-3;
