...
% =========================================================================
% 2018_04_25
% first few shots, very low density
shotlist = [21000 + [372,470]];
% RF to 6v, TR2 = 120 A
shotlist = [21000 + [477]];
% RF to 9.96v, TR2 = 180 A, PS1/2 = 4.5kA
shotlist = [21000 + [332,333,411,478,479,480]];

% TR2 = 60 A, PS1/2 = 2.5 kA, various RF power with ECH
shotlist = [21000 + [481,483,484,485,486]];
% Begin PS1 scan
shotlist = [21000 + [486,488,489,490,492]];
PS1      =          [2.5,3.0,3.5,4.0,6.0];
% % Reduce RF between relative 492 
% shotlist = [21000 + [492,493,494]];
% RF       =          [4  ,3  ,2  ] ;
% 
% % TR2 = 40 A, PS2 = 2kA
% shotlist = [21000 + [493,494,497,502,503,504]];
% % RF       =          
% % PS1      =
% % no RF and ECH only, we saw plasma
% % shotlist = 21000 + 491
% 
% % PS1/2 = 4 kA and RF power scan
% % saw signs of trapping
% shotlist = [21000 + [504,505,506,509,510,513,516]];
% shotlist = [21000 + [510,516]];
% 
% % PS1/2 = 4 to 2 kA
% shotlist = [21000 + [513,514,515,520]];
% PS12     =          [4  ,3  ,3  ,2.5] ;
% 
% % Comparing two shots at 5.5 v and TR2 = 40 A PS1/2 = 2.5 kA but differnt
% % match
% shotlist = [21000 + [484,521,522]];
% 
% % Increased TR2 = 60 A, PS1/2 = 2.5 kA
% shotlist = [21000 + [525]];

shotlist = 21000+[629,630];
shotlist = 21678
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.12 & Ni{s}>0 & Ni{s}<12e19 & Te{s}<=12 & Is{s}>0.01e-3;
