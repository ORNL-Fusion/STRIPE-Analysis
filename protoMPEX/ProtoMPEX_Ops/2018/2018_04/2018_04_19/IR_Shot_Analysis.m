...
shot(1) = 20833; % 2.5 kA case, probe removed
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2018_04_03';

% % 2018_04_05
% shot(1) = 20958; % all probes removed  
% shot(1) = 20919; % all probes removed  
shot(1) = 20927; % 2.5 kA case 
% shot(1) = 20928; % 2.0 kA case 
% 
% shot(1) = 20958; % 2.0 kA case, probe removed
% 
