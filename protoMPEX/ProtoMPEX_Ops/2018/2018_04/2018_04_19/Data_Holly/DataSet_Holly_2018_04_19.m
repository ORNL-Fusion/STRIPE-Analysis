...
DownloadData = 1;
SaveData = 1;
DataName = 'DataSet_Holly_2018_04_19_RawData';
...
% =========================================================================
    ...
    MetaData.shot      =    [21341 ,21347 ,21348, 21338, 21340];
    MetaData.rGauge    =    [8.5   ,8.5   ,8.5  , 8.5  , 8.5  ] ;
    MetaData.RF_volts  =    [8     ,7     ,6    ,9.96  ,9.96  ] ;
    MetaData.DataSetDescription     = ['Data for Holly'];
    %--------------------------------------------------------------------------------------------------------------------------------------
    % Define ADDRESSES
    Address.V   =        {aV{1}};
    Address.I   =        {aI{2}};
...
k = 0;
for s = 1:length(RawData.shot)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.25 & Ni{s}>0 & Ni{s}<1e21 & Te{s}<=15;
