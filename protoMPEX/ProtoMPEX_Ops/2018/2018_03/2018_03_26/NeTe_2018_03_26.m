...
shotlist = [20000 + [477,478,479,480,481,482,483]];
R            =          [0.5,0.5,0.5,0.5,0.5,0.5,0.5] ;

shotlist = [20000 + [484,485,487,488]];
shotlist = [20000 + [497,498,500]];
% shotlist = [20000 + [498,505,506]];

% =========================================================================
% Flux probe on-axis, helicon + ECH, 1 sec pulses
% shotlist = [20000 + [497,498]];
% =========================================================================
...
% #########################################################################
% =========================================================================
shotlist = [20000 + [489,490,491]];
shotlist = [20000 + [491,492,495]];
shotlist = [20000 + [502,504]];

shotlist = [20000 + [490,491,496]];
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.07 & Ni{s}>0 & Ni{s}<1e21 & Te{s}<=30;
