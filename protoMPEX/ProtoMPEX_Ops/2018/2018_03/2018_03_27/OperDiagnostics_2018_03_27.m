...
% 2017_12_19
RemoveOffset = 0;
shotlist = [19000 + [588,603,604:606]];
shotlist = [19700 + [65,68]];
% shotlist = [19700 + [78,69]];
shotlist = [20000 + [550:555]]

% Neutral gas pressure scan for the flux probe XPs
shotlist = [20000 + [555,554,553,550,551,552]];
GF       =          [2  ,3  ,4  ,5  ,6  ,7  ] ;
% ########################################################################
% % 2018_03_27, 
% % ECH paddle probe XPs, PS1 = 2kA, PS2 = 4.5 kA
% % shotlist = [20000 + [576,577,578,579,580,585]];
% % xProbe   =          [10 ,10 ,6  ,6  ,5  ,4.5];
% % 
% % ECH paddle probe XPs, PS1 = 4.5 kA, PS2 = 4.5 kA
% % shotlist = [20000 + [601,602,603,607]];
% % xProbe   =          [10 ,10 ,5  ];
% ########################################################################
...
Calshot  =         ones(size(shotlist))*20556;
PGcenter =         [];
