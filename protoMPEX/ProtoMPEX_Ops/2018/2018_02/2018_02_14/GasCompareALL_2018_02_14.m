...
% Comparing MFC and Piezo puffer
% shotlist = 17500 + [40,42]
% shotlist = 17500 + [40,46]
% shotlist = [17921,17984]
% shotlist = [17710,17983,17984]
% shotlist = [17671,17985,17986,17987]
% shotlist = [20083]
% shotlist = [20080]
shotlist = [19857,19855,20102,19867,19905,19912,20116];
shotlist = [20024,20025,20047,20057,20058];
shotlist = [20029:20045];
shotlist = [20044:20054];
shotlist = [21713,21730:21731];
shotlist = [21269,21739,21226];
...
for s = 1 :length(shotlist)
    P{1}{s} = ( PG1{s}(1:Ldata)-b*PG1cal{1}(1:Ldata) )*2*fctr;
    P{2}{s} = ( PG2{s}(1:Ldata)-b*PG2cal{1}(1:Ldata) )*2*fctr;
    P{3}{s} = ( PG3{s}(1:Ldata)-b*PG3cal{1}(1:Ldata) )*2*fctr;
    P{4}{s} = ( PG4{s}(1:Ldata)-b*PG4cal{1}(1:Ldata) )*10*fctr;
