...
shotlist = [20000 + [8:11]];
% 2018_02_28
shotlist = 20000 + [31,32,33];
% 2018_03_01
shotlist = 20000 + [77,78,79,80];
shotlist = 20000 + [80,116,117];
shotlist = 20000 + [135,136,137,138];
shotlist = 20000 + [138,141,144,146];
shotlist = 20000 + [154,155,162,168,169,170];

% 2018_03_07
% TR1/2 600/160 Ps1/2 4500/4500 A, upstream puffing
% DLP 10.5
shotlist = 20000 + [191];
% DLP 1.5
shotlist = 20000 + [194,195,196,197,198 ,199 ,200 ,201 ];
x        =         [8.5,9.0,9.5,10 ,10.5,11.0,11.5,12.0];

% shotlist = 20000 + [200 ,201 ,202 ,203 ,204 ,205 ,206 ,207 ];
% x        =         [11.5,12.0,12.5,13.0,13.5,14.0,14.5,15.0];
% 
% shotlist = 20000 + [194,208,210,211];
% x        =         [8.5,8.0,7.5,8.5];
