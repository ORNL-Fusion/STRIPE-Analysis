...
switch ShotType
    case 1 
        shotlist = [28000 + [433,436,437,438]]; 
        shotlist = [28000 + [438,439,441]]; 
        shotlist = [28000 + [441,442,443]]; 
        shotlist = [28000 + [438,443,446]]; 
        shotlist = [28000 + [446,447]]; 
        shotlist = [28000 + [433,450,451]]; 
        shotlist = [28000 + [451,452,453]]; 
        shotlist = [28000 + [459,460,461]]; 
        shotlist = [28000 + [441,461,462]]; 
        shotlist = [28000 + [441,464,465,470]]; 
        shotlist = [28000 + [470,471,473,475,476]]; 
        shotlist = [28000 + [473,475,476]]; 
