...
switch shotType
    ...
    % 2019_08_09
    % DLP 12.5
%     shotlist = [27000 + [427,428,429,430]];

    % bfield scan with constant flux mapping with skimmer problem
%     shotlist = [27000 + [428,429,430,431,433]];
    % PS3      =          [220,160,160] ;
    % PS1      =          [4.0,2.9,4.0] ;
%     shotlist = [27000 + [435,437,438,439]];

    % Donwhill configuration
%     shotlist = [27000 + [428,440,441,442,443]];
%     shotlist = [27000 + [445,447,448,449]];

    shotlist =  [27000 + [428,435,437,448,449]];

    case 2
    % 2019_08_13
    shotlist = [27000 + [469,473,474,477]];

    shotlist = [27000 + [478,479,482,483,485]];


    shotlist = [27000 + [483,485,486,487 ]];
    Puff4    =          [0.1,0.3,0.2,0.25];

    shotlist = [27000 + [485,486]];
    Puff4    =          [0.3,0.3];

    shotlist = [27000 + [490,491,492,493,494,495,496,497]];
    PS1    =            [3.5,3.5,4.5,4.7,4.9,5.1,5.3,5.5];

    shotlist = [27000 + [477,497,498,499]];
    PS1    =            [5.5,5.5,5.5,6.0];
