...
% 2019_08_19
% DLP 12.5
shotlist = [27000 + [550,551,552,553]];
shotlist = [27000 + [497,536,555,556]];
shotlist = [27000 + [497,557]];
shotlist = [27000 + [497,559,564],26827];
shotlist = [27000 + [564,566,567,568]];
shotlist = [27000 + [573,574]];
shotlist = [27000 + [564,579,581,582]];
shotlist = [27000 + [582,583,584,585,586]];
shotlist = [27000 + [586,587,588,589]];
shotlist = [27000 + [589,590,591,592]];

% 2019_08_20
% DLP 12.5
shotlist = [27000 + [600:602]];


ShotType = 5;
switch ShotType
    case 1
        % first high density shots
        shotlist = [27000 + [553,559]]; 
    case 2   
        % Changing the mirror ratio
        shotlist = [27000 + [559,563,564]]; 
    case 3   
        % Increasing helicon field
        shotlist = [27000 + [564,566,567]]; 
    case 4   
        % Increasing gas flow
        shotlist = [27000 + [564,566,567,581:583]]; 
    case 5   
        % Highest performance shots
        shotlist = [27000 + [584,586,591]]; 
end
