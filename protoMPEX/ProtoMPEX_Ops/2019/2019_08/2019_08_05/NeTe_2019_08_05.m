...
% 2019_08_05
% DLP 12.5
shotlist = [27000 + [272,273,274]];
shotlist = [27000 + [273:275]];
shotlist = [27000 + [275,276]];
shotlist = [27000 + [276,279,280,281]];
shotlist = [27000 + [285,286,287], 26804];

shotlist = [27000 + [287], 26804,26807];
shotlist = [27000 + [288,289,290,291], 26804];
shotlist = [27000 + [291,292,297], 26804];
...
% -------------------------------------------------------------------------
% Helium operation
shotlist = [27000 + [298,299,300:302]];

Config.AMU = 4; % Ion mass in AMU
DLPType = '12MP';

% -------------------------------------------------------------------------
% Back to D2 operation
shotlist = [27000 + [297,305,306,307]];
shotlist = [27000 + [310,312]];

% Looking at last shots where we saw the high density mode
shotlist = [27000 + [297,151],26827,26895];

% shot 26827 was taken on July 10th
shotlist = [27000 + [321,322,323,324,325],26827];
...
% -------------------------------------------------------------------------
% Use DLP 12.5
shotlist = [27075,27338,27029,26942,26934];
shotlist = [27338,26894:26904];
shotlist = [27338,26894,26827,26832,26871,26872];
shotlist = [26878,27338,26827];
shotlist = [27338, 26878:26882];
shotlist = [27338, 26878, 26889,26890];

shotlist = [27338, 26900:26910]; % Still good neutral gas pressure

shotlist = [27338, 26912,26913,26934,26935]; % some unusual behaviort

shotlist = [27338,26939]; % still good neutral gas pressure
shotlist = [27338,26946]; % pressure it not very good here

shotlist = [27338,26939,26959:26962]; % Pressures not very good
shotlist = [27338,26939,27000]; % Pressures not very good, 27K had two puffers

shotlist = [27338,27074]; % Pressures not very good, 27K had two puffers

shotlist = [27338,27276,26543]; 

shotlist = [27338,27342]; 
shotlist = [27345,27276]; 
