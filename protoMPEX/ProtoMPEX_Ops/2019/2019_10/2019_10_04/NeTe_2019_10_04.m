...
switch ShotType
    case 1
        shotlist = [28000 + [56,57,58],27995];
        shotlist = [28000 + [62,63,64],27995];
        shotlist = [28000 + [69,71]];
        shotlist = [28000 + [62:64]];
    case 2
        shotlist = [28000 + [35:37]];        
        shotlist = [28000 + [40,42]];        
        shotlist = [28000 + [54,55]];        
        shotlist = [28000 + [62]];  
        % changed to downhill configuration
        shotlist = [28000 + [66,67]];     
