...
switch ShotType
    case 1
        shotlist = [28000 + [85,86],27863];
%         shotlist = [28000 + [85,86,90],27995];
    % Comparing one of today's good shot swith those of 2019-09-13 prior to
    % the arching problmem witth the probe which we think damgaged it
            shotlist = [28000 + [86],27863,27850];
            
            
            shotlist = [28000 + [90,91,92]];
            shotlist = [28000 + [96]];
            shotlist = [28000 + [99]];

    case 2
        shotlist = [28000 + [90,91]];
        shotlist = [28000 + [92]];
        shotlist = [28000 + [93]];
        shotlist = [28000 + [92:94]];
        shotlist = [28000 + [95]];
        shotlist = [28000 + [96]]; % Good density drop

    case 3 % RAdial scan
        shotlist = [28000 + [96,  97,98,  99,100,101 ,102 ,103 ,104,105,106]];
        R        =          [10,10.5,11,11.5,12 ,12.5,13.0,13.5,10 ,9.5,9.0] ;

    case 4 % Down hill
        shotlist = [28000 + [104,116,117,119,120,121]];
        shotlist = [28000 + [117,118,119,120,121]];
    case 5
