...
switch XP
    case 1
        shot       = 28000 + [86];
        shot       = 28000 + [90];
        shot       = 28000 + [91]; % PS3 = 440 A
        shot       = 28000 + [92]; % PS3 = 480 A
        shot       = 28000 + [93]; % PS3 = 480 A
        shot       = 28000 + [94]; % PS3 = 480 A
        shot       = 28000 + [99]; % PArt of the radal scan
        shot       = 28000 + [106]; % PArt of the radal scan
        shot       = 28000 + [110]; % PArt of the radal scan
        shot       = 28000 + [112]; % Clean IR for uphill configuration
%         shot       = 28000 + [113]; % Clean IR for uphill configuration, no ECH
        shot       = 28000 + [117]; % Downhill configuration
        shot       = 28000 + [119]; % Downhill configuration
        shot       = 28000 + [120]; % Downhill configuration
