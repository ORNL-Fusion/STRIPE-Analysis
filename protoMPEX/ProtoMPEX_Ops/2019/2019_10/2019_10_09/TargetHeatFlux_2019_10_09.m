...
switch xp
    ...
    case 1 % Clean IR shot with ECH, uphill
        shot       = 28000 + [112];
        addressLoc =         [ 1]; 
        
    case 2 % Clean IR shot Helicon only, uphill
        shot       = 28000 + [113];
        addressLoc =         [ 1];   
        
    case 3 % Clean IR shot Downhill conf 
        shot       = 28000 + [114];
        addressLoc =         [ 1];    
        
    case 4 % Clean IR shot Downhill conf lowest downhill field
        shot       = 28000 + [116];
        addressLoc =         [ 1];          
        
    case 5 % Clean IR shot Downhill conf lowest downhill field, lowest gas
        shot       = 28000 + [120];
        addressLoc =         [ 1];          
...
% =========================================================================
a{1} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2019_10_09'];
...
for s = 1:length(shot)
    ...
    thermalParam.emissivity = 0.2;

    % Define extraction options:
    extractOptions.frames = 1:1:250;
