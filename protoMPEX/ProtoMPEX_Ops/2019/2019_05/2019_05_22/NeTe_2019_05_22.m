...
% #########################################################################
% 2019_05_22
shotlist = [26000 + [208,209,211,212,213],26165];
shotlist = [26000 + [301,304,310]];
shotlist = [26000 + [320,321,322,324]];
shotlist = [26000 + [325,326,327]];
shotlist = [26000 + [335,339,340]];
shotlist = [26000 + [340,342,347]];
shotlist = [26000 + [347,349,351,355]];
Config.AMU = 2; % Ion mass in AMU


shotlist = [26000 + [425,427:430]];
shotlist = [26000 + [432,435,436,439]];
...
shotlist = [26000 + [441,442,443,445,447]];
shotlist = [26000 + [449,450,451]];
Config.AMU = 4; % Ion mass in AMU
DLPType = '6MP';

shotlist = [26000 + [459,460,461,462,464]];
shotlist = [26000 + [481,475]];
shotlist = [26000 + [165,475]];
...
if 0
    for s = 1:length(shotlist)
        ...
        FileName = ['Shot_',num2str(shotlist(s)),'_NeTe_Target_DLP_12_5.xlsx']
