...
% #########################################################################
% 2019_05_01
shotlist = [26000 + [153,161], 26143];
shotlist = [26000 + [162,163,165]];

% shotlist = [26000 + [153,155,157,158], 26143];
% shotlist = [26000 + [159,161,162,163], 26143];
% shotlist = [26000 + [163,165]];

% shotlist = [26000 + [163,166,167]];
% shotlist = [26000 + [171,172,173]];
% 
Config.AMU = 2; % Ion mass in AMU
DLPType = '12MP';
% 
% shotlist = [26000 + [180 181 182]];
% Config.AMU = 2; % Ion mass in AMU
% DLPType = '6MP';
% 
% shotlist = [26000 + [171,187,188,189]];
% shotlist = [26000 + [189,190,191,192]];
% shotlist = [26000 + [190,194,195]];
% shotlist = [26000 + [195]];
% Config.AMU = 3; % Ion mass in AMU
% DLPType = '12MP';
% 
% shotlist = [26000 + [198]];
% Config.AMU = 3; % Ion mass in AMU
% DLPType = '6MP';
% 
% shotlist = [26000 + [195,199,200]];
% shotlist = [26000 + [195,201]];
% 
% Config.AMU = 3; % Ion mass in AMU
% DLPType = '12MP';
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.25 & Ni{s}>0 & Ni{s}<30e19 & Te{s}<=20 & Is{s}>0.01e-3;
