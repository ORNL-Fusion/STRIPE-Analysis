...
% #########################################################################
% 2019_04_22
shotlist = 25000 + [1026,1031];
shotlist = 25000 + [1026,1033,1034];
% Changing gas conditions:
shotlist = 25000 + [1034,1036];
shotlist = 25000 + [1034,1036,1037];
shotlist = 25000 + [1035,1037];
shotlist = 25000 + [1037,1038];
shotlist = 25000 + [1034,1036,1037,1038,1039];
shotlist = 25000 + [1039,1040];
shotlist = 25000 + [1040,1041,1042];

shotlist = 25000 + [1042,1045,1046,1047,1048,1050];
shotlist = 25000 + [1050,1053,1054];
shotlist = 25000 + [1055,1056];

% Magnetic field scan
shotlist = 25000 + [1056,1057,1058,1059,1060,1062];
PS3      =         [220 ,180 ,160 ,160 ,140 ,140];

shotlist = 25000 + [1056,1064,1066,1069];
PS3      =         [220 ,260 ,300 ,330 ];

shotlist = 25000 + [1059,1056,1064,1066,1069];
PS3      =         [160 ,220 ,260 ,300 ,330 ];

shotlist = 25000 + [1069,1070,1071,1072];
PS3      =         [330 ,330 ,360 ,400 ];

shotlist = 25000 + [1069,1070,1075,1077];
PS3      =         [330 ,330 ,330 ,330 ];

Config.AMU = 4; % Ion mass in AMU
DLPType = '12MP';

shotlist = 25000 + [1078,1090];
PS3      =         [330 ,200 ];
