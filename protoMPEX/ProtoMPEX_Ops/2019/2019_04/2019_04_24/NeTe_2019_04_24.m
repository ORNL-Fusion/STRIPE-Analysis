...
% #########################################################################
% 2019_04_24
shotlist = 25000 + [1093,1094,1095];
PS3      =         [220 ,220 ,220 ];

% Magnetic field scan:
% DLP 12.5
shotlist = 26000 + [101:103];
PS3      =         [];
...
% Magnetic field scan:
% DLP 6.5
shotlist = 25000 + [1105,1106,1107,1116];
PS3      =         [700 ,700 ,800 ,800];
DLPType = '6MP';

shotlist = 25000 + [1122,1123,1124,1125,1126];
PS3      =         [360 ,360 ,360 ,360 ,360 ];

shotlist = 25000 + [1126,1127,1128,1129,1078];
PS3      =         [360 ,330 ,330 ,330 ,330 ];

shotlist = 25000 + [1130,1126,1127,1128,1129,1078];
PS3      =         [360 ,330 ,330 ,330 ,330];

% Mirror ratio scan
% DLP 6.5
shotlist = 25000 + [1129,1131,1132,1133,1134,1135];
TR2      =         [3750,3250,3250,2800,2400,1920];
DLPType = '6MP';

% DLP 12.5
shotlist = 25000 + [1134,1136];
TR2      =         [2400];
DLPType = '12MP';

shotlist = 25000 + [1136,1137,1138,1139,1140];
TR2      =         [2400,2400,2400,2400,2400];
DLPType = '12MP';
