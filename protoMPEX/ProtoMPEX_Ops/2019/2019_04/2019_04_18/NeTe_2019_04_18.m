...
% #########################################################################
% 2019_04_18
shotlist = 25000 + [960,961];
shotlist = 25000 + [960,961,962];
% shotlist = 25000 + [962,963];
shotlist = 25000 + [962,969];
Config.AMU = 2; % Ion mass in AMU
% 
% % Helium shots:
% % Gas only:
% shotlist = 25000 + [998,999];
% % RF plasma
shotlist = 25000 + [1001];
% shotlist = 25000 + [1001:1003];
% shotlist = 25000 + [1005];
% shotlist = 25000 + [1005,1006];
% shotlist = 25000 + [1007,1008];
% shotlist = 25000 + [1009,1010];
shotlist = 25000 + [1015];
% shotlist = 25000 + [1017];
shotlist = 25000 + [1019,1021];
% Add ECH to the pulses:
shotlist = 25000 + [1024,1025,1026];
shotlist = 25000 + [1026];
% shotlist = 25000 + [1029];
% 
