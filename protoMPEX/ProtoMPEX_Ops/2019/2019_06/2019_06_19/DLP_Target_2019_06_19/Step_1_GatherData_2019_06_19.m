...
if fetchDataFromServer
    ...
    % =========================================================================
    MetaData.shot      = [26000 + [676,678,679,680,681,682 ,683 ,684 ,685 ],20908];
    MetaData.rgauge    =          [9.5,9.0,8.5,8.0,7.5,10.0,10.5,11.0,11.5] ;
    MetaData.DataSetDescription     = ['DLP 12.5 radial scan with Window-limiter configuration 2019_06_19'];
    ...
    fileName = ['Step_1_RawData_2019_06_19.mat'];
