...
shotlist = [26000 + [676,678,679,680,681,682 ,683 ,684 ,685 ,686]];
R        =          [9.5,9.0,8.5,8.0,7.5,10.0,10.5,11.0,11.5,9.5] ;

% shotlist = [26000 + [676,686]];
shotlist = [26000 + [704,705,709]];

shotlist = 26000 + [646,647,648,649,650,653,655,656,743,745,746,747,748,750];
shotlist = [26000 + [664]];
