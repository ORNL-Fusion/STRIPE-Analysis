...
% #########################################################################
% 2019_06_27
% start with new magnetic field configuration:
% TR1 = none 
% TR2: Coil 2
% PS1: Coils 1,6,7,8
% PS2: Coils 9-13
% PS3: Coils 3,4
% USING SINGLE TRANSMITTER SAIREM

% First good pulse of the day, net power ~90 kW
shotlist = [26000 + [717:719]];

% Shots associated with 1st sequence of IR images:
shotlist = [26000 + [728:733,735]];

% comparing two shots
shotlist = [26000 + [646,647,648,733]];

% Ne values for bottom view power scan
% comparing two shots
shotlist = [26000 + [729:734]];
