% In v2, we attempt to reduce the computational time required to complete
% the calculation.
...
% - 58 sec from extracting data and creating "img" variable
% - 6 sec from Interp1 
% - 6 sec from sum(sum(
% - 14 sec from RawData
...
for s = 1:length(shot)
    ...
    ThresholdGradient(s) = D0{s}(nx,ny);
end
toc
%%
% =========================================================================
