...
switch xp
    case 1                
        ...
        rfPwrNet   =         [104,122,135,145,160,169,93 ,88 ,80 ,68 ,58 ,48 ];
...
% Would you like to load IR raw files?
% if yes, user may want to calculate
% if no, we may need to reload previously calculated data
...
toc
disp('.seq files loaded!!'); msgbox('.seq files loaded!!');
