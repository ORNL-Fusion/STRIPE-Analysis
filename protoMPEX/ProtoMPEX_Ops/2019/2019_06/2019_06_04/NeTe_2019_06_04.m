...
% #########################################################################
% 2019_06_04
shotlist = [26000 + [490,491],26326,26385];

% Combined RF power with ne up to 1.2e20 m3
shotlist = [26000 + [505,506,512,513,519,520,526]];
shotlist = [26000 + [538,541,542,543,546,547]];
Config.AMU = 2; % Ion mass in AMU
DLPType = '12MP';

% shotlist = [26000 + [531,532,533],26];
% Config.AMU = 2; % Ion mass in AMU
% DLPType = '6MP';

% 2019_06_06
shotlist = [26000 + [551,552,553]];
Config.AMU = 2; % Ion mass in AMU
DLPType = '12MP';


% 2019_06_04, PS2 scan 
shotlist = [26000 + [527,538,541,542,543]];
PS2      =          [3.5,4.0,4.5,5.0,6.0]


shotlist = [26000 + [505,506]];

shotlist = [26000 + [512,513,519,520]];

shotlist = [26000 + [538,541,542,543,546,547]];

shotlist = [26000 + [565,604]];
