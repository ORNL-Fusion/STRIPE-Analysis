...
if fetchDataFromServer
    ...
    % =========================================================================
    MetaData.shot      = [27000 + [863 ,864,865,866,868,870 ,873 ,874 ,880 ,900 ,902 ,903 ],20908];
    MetaData.rgauge    =          [10.0,9.5,9.0,8.5,8.0,10.5,11.0,11.5,12.0,12.5,13.0,13.5] ;
    MetaData.DataSetDescription     = ['DLP 12.5 radial scan with Window-limiter configuration at PS3 = 650 A, 2019_09_13'];
    ...
    fileName = ['Step_1_RawData_2019_09_13.mat'];
