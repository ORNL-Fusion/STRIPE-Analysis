...
switch ShotType
    case 1
        % DLP 12.5
        % Bfield scan
        shotlist = [27000 + [623,624,625,627,628,630]];
        PS3      =          [340,370,400,430,450,490] ;

    case 2
        % DLP 12.5
        % Operation at PS3 = 550 A,density drop at the end of shot, using 7.5 V
        % drive which would correspond to about 140 kW net. we may be Underpowered
        shotlist = [27000 + [634]];
        
    case 3
        % DLP 12.5
        % RF power Fall back (~100 kW), breakdown at PS3 = 650 A
        shotlist = [27000 + [640]];
        
    case 4
        % DLP 12.5
        % Probe possibly self-emitting at the end of pulse
        shotlist = [27000 + [644,645]];
        
    case 5
        % DLP 12.5
        % PS3 = 550 A
        % Reduction in density at the end of shot
        % RF power level to ~ 140 kW
        shotlist = [27000 + [659,660]];
        PS3      =          [550,550] ;
        
    case 6
        % Best results from Today
        shotlist = [27000 + [623,624,625,627,628,630,644]];
        PS3      =          [340,370,400,430,450,490,600] ;
        RFdrive  =          [7  ,7  ,7  ,  7,  7,  7,8.5] ;
        
    case 7
        % DLP 12.5
        % Increase in Pressure at the target
        shotlist = [27000 + [628,629]];
        PS3      =          [450,490] ;
end
