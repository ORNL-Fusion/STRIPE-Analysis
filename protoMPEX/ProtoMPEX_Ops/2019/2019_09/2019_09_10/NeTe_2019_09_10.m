...
switch ShotType
    case 1
        shotlist = [27000 + [692,630,743,762,763,764,765]];
        shotlist = [27000 + [630,768,772]];
        shotlist = [27000 + [630,794,806]];        
        PS3      =          [] ;
        RFp      =          [7  ] ;
        
    case 2
        shotlist = [27000 + [842,844,846,849]];        
        shotlist = [27000 + [850,851,852]];        
        shotlist = [27000 + [852,853]];        
        shotlist = [27000 + [853,854]];            
        shotlist = [27000 + [854,855,856]];            
        shotlist = [27000 + [856,857]];            
        shotlist = [27000 + [865,866]];            
        shotlist = [27000 + [895]];                    
        shotlist = [27000 + [903]];                    
        
    case 3
        shotlist = [27000 + [724,728]];                    
        shotlist = [27000 + [760,762]];                    

    case 4
        % Data from 2019_09_12
          shotlist = [27700 + [87:89,94]];                    
          shotlist = [27700 + [95:97]]; 
          shotlist = [27000 + [803,806]];                    
