...
% 2019_07_10
% DLP 12.5
% 1st full pulse, low density
shotlist = [26000 + [823]];
shotlist = [26000 + [824,825,826]];
% 1st high power full pulse
shotlist = [26000 + [827,828]];
% Reduce RF power to increase gas pressure at source:
shotlist = [26000 + [828,836,837,838,840]];
shotlist = [26000 + [843,844]];
% Increase pulse to 1 sec 
shotlist = [26000 + [850,853,860]];

% Increase pulse to 1 sec 
shotlist = [26000 + [804,805,806,809,815,816]];
