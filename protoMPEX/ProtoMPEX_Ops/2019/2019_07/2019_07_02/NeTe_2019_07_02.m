...
% -------------------------------------------------------------------------
% DLP 12.5
% TR2 (coil 2) = 0 A and downstream puffing
% first few pulses of the day
shotlist = [26000 + [756:759]];
DLPType = '12MP';
% Increased gas flow
shotlist = [26000 + [760]];
DLPType = '12MP';
% Decreased gas flow
shotlist = [26000 + [760,762]];
DLPType = '12MP';
% Changed gas timming
shotlist = [26000 + [762:764]];
DLPType = '12MP';
% Three gas flow levels:
shotlist = [26000 + [759 ,760 ,762]];
GasFlow  =          [1.15,1.20,1.20] ;
DLPType = '12MP';

% Changed to DLP 6.5
shotlist = [26000 + [765:767]];
DLPType = '6MP';
% -------------------------------------------------------------------------
% DLP 6.5
% Increased TR2 from 0 A to 200 A and then to 520 A
shotlist = [26000 + [767,769,770]];
TR2      =          [0  ,200,520] ;
DLPType = '6MP';
% -------------------------------------------------------------------------
% DLP 12.5
% Changed back to DLP 12.5 and continue using TR2 = 520 A but scan coils
% 3,4 from 220 to 260 A
shotlist = [26000 + [771:774]];
% TR2      =          [0  ,200,520] ;
DLPType = '12MP';
% -------------------------------------------------------------------------
% DLP 12.5
% Compare effect of coil 2 at 0 A and 520 A on Target density
% both have coil 3-4 = 220 A
shotlist = [26000 + [764,771]];
TR2      =          [0  ,520] ;
DLPType = '12MP';
...
DLPType = '12MP';
% -------------------------------------------------------------------------
% Shots recommended by Cornwall 2019_06_27
% DLP 12.5
shotlist = [26000 + [744,756:758]];
DLPType = '12MP';
...
switch DLPType 
    ...
    case '6MP'
        ...
        Config.L_tip = 2.0/1000; % 2.0 as of June 18th 2019
        Config.D_tip = 0.254/1000; % [m]
    case '10'
        DLP = 10.5;
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.5 & Ni{s}>0 & Ni{s}<30e19 & Te{s}<=20 & Is{s}>0.01e-3;
