...
RootAddress = pwd;
a{1} = [RootAddress(1:end-11),'\2019_07_02','\IR_RawData'];
a{2} = [RootAddress(1:end-11),'\2019_06_27','\IR_RawData'];
...
for s = 1:length(shot)
    ...
    NmaxX = size(SqNormD0,1);
    NmaxY = size(SqNormD0,2);
    Nrem = 70;
    SqNormD0(1:Nrem            ,:                 )  = 0;
    SqNormD0([NmaxX-Nrem]:NmaxX,:                 )  = 0;
    SqNormD0(:                 ,1:Nrem            )  = 0;
    SqNormD0(:                 ,[NmaxY-Nrem]:NmaxY)  = 0;
