...
% DLP 12.5
% Helium discharges
shotlist = [27200 + [21,22,23,24,25,26:30]];
% shotlist = [27200 + [32]];
shotlist = [27200 + [32,33,34,35]];
shotlist = [27200 + [35,36]];

% Increased bias
shotlist = [27200 + [36,37]];
% Increased PS3
shotlist = [27200 + [37 ,38 ,39 ,40 ]];
PS3      =          [300,400,500,600];

shotlist = [27200 + [41]];

% PS3 = 300 w and w/o 2nf puffer
shotlist = [27200 + [42,43]];

% PS3 = 300, effect of increasing mirror ratio
shotlist = [27200 + [45,46]];
