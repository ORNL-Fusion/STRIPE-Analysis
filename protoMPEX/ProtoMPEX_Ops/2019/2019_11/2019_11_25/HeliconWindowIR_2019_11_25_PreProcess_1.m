...
switch xp
    case 1        
        shot       = 28000 + [382,383,384,385,389];
        rfPwrNet   =         [117,116,115,114,116];
        addressLoc =         [1  ,1  ,1  ,1  ,1  ];
        viewType   = 'Window_Limit_Bottom'; 
     
    case 2
        shot       = 28000 + [396,397,398,399,400];
        rfPwrNet   =         [116,117,118,119,114];
        addressLoc =         [1  ,1  ,1  ,1  ,1  ];
...
% =========================================================================
a{1} = [cd,'\IR_Data'];
% a{1} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2019_11_25'];
% a{2} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2019_11_18'];
...
if cmptThresholds
   ...
   save(['preprocessData_xp_',num2str(xp)],'shot','rfPwrNet','addressLoc','-append'); 
