...
switch ShotType
    case 1 
        shotlist = [28000 + [267,273,274,275]]; 
        shotlist = [28000 + [275,276,280]]; 
        shotlist = [28000 + [280,282,283,285]]; 
        shotlist = [28000 + [285,286]]; 
        shotlist = [28000 + [286,289]]; 
%         shotlist = [28000 + [289,290:293]]; 
%         shotlist = [28000 + [294]]; 

    case 2 
        shotlist = [28000 + [331,332,333,334]]; 
        shotlist = [28000 + [334,337]]; 
    case 3
        shotlist = [28000 + [299,308]]; 
