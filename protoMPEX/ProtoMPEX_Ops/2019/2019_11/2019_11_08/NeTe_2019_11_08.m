...
switch ShotType
    case 1
        % First HMJ shot on 2019_11_08, 80 kW net single XT
        shotlist = [28000 + [199,200,201,202 ]];
        PS1      =          [5.5,4.5,5.0,4.75] ;
        RFp      =          [80 ,81 ,80 ,81  ] ;
    case 2
        % A shot from previous XP campaing with 86 kW net combined XT
        % These are hard to compare since they have ECH and different PS3
        % current
        shotlist = [28000 + [164,171,172,199]];
    case 3 
        % These two are very comparable
        shotlist = [27433,28000 + [199]];
    case 4
