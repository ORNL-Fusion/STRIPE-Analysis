...
switch ShotType
    case 1 
        shotlist = [28000 + [245,254,255,256]]; 
        shotlist = [28000 + [256,258,259,261]]; 
        shotlist = [28000 + [245,261,262,263]]; 
        shotlist = [28000 + [245,265,266,267]];
        
        shotlist = [28000 + [261,262,263,265,267]];
        shotlist = [28000 + [265,267]];
    case 2 % Comparing with data from 2019_09_13    
        shotlist = [27838,28000 + [265]]; 
    case 3 % Comparing with data from 2018_11_01
        shotlist = [28000 + [145,267]];
end
