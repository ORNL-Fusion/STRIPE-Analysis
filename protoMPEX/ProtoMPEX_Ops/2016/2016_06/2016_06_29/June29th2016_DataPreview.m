...
%Extract data:
Spool = 9.5;
% Shots = 9100 + [31:34]; % y = +2 cm, ECH on and off
% Shots = 9100 + [39:46]; % 
% Shots = 9200 + [90,96:100,102,103,106:109];
%Shots = 9100 + [31:32,35:36];


% Shots with ECH data:
Shots = [9131,9132,9133,9142];
%Shots = [9135,9136]; 
%Shots = [9138,9139]; % no heating observed
%Shots = [9140,9142];
%Shots = [9144,9146];

%Shots = [9131,9132,9133];
%Shots = [9136,9138,9146] ; % y = +3 and -2 cm respectively, ECH 4.26
%Shots = [9135,9142];     % y = +0 and +2 cm respectively, ECH 4.26
%Shots = [9139,9140]; % y = +1 cm both,
