...
%Extract data:
Spool = 9.5;
Shots = [9328];%[8998,9011,9018,9025];

% 8912: DLP 6.5, y =    0 cm,    mode jump,   5e19 m-3, sym
% 8917: DLP 6.5, y =    0 cm,    mode jump,   4e19 m-3, sym
% 8924: DLP 6.5, y =    0 cm,    mode jump,   4e19 m-3, sym
% 8929: DLP 9.5, y =    0 cm,    mode jump,   4e19 m-3, sym

% 8975: DLP 9.5, y =    0 cm,    mode jump, 5.5e19 m-3, sym
% 8998: DLP 6.5, y =    0 cm, NO mode jump,   2e19 m-3, sym
% 9011: DLP 6.5, y =    0 cm, NO mode jump,   2e19 m-3
% 9018: DLP 6.5, y = -0.5 cm, NO mode jump,   2e19 m-3
% 9024: DLP 6.5, y = -3.0 cm,    mode jump,   2e18 m-3
% 9025: DLP 6.5, y =    0 cm,    mode jump,   3e19 m-3

% 9247: DLP 9.5, y =    0 cm,    mode jump, 5.5e19 m-3, sym
% 9252: DLP 9.5, y =    0 cm,    mode jump,   5e19 m-3, sym
% 9263: DLP 9.5, y =    0 cm,    mode jump,   4e19 m-3, slight asym
% 9265: DLP 6.5, y =    0 cm,    mode jump, 1.5e19 m-3, slight asym
% 9302: DLP 6.5, y =    0 cm,    mode jump,   5e19 m-3, slight asym
% 9303: DLP 6.5, y =    0 cm,    mode jump,   4e19 m-3, slight asym
 
% 9319: DLP 6.5, y =    0 cm,    mode jump,   3e19 m-3, asym
% 9322: DLP 6.5, y =    0 cm,    mode jump,   3e19 m-3, strongly asym
% 9322: DLP 6.5, y =    0 cm,    mode jump,   5e19 m-3, slight asym
...
% for s = 1:length(Shots)
%     plot3(time{s},s*ones(size(Ni{s})),Ni{s},C(s))
% end
% title('N_i')
% ylim([0,8e19])
