...
shotlist = 11700 + [20,21,22,23,24,25];
shotlist = 11700 + [29,30,32,33,34];
shotlist = 11700 + [36,37];
shotlist = 11700 + [39,40,41,49,50,51];
shotlist = 11700 + [65,66,67,69];

shotlist  = 11700 + [73,74];

shotlist  = 11700 + [77,78,79,80,82,84,85,86];
shotlist  = 11700 + [86,87,88,89,90,91];

shotlist  = 11700 + [93,94,95,96,97,98,99,100,102,104];

shotlist  = 11700 + [110];
shotlist  = 11700 + [114,115,116,117];

shotlist  = 11700 + [119,120,121];
% shotlist  = 11700 + [123,124,125,127];
shotlist  = 11700 + [128,129,130];
AddressType='n'; % s for standard, 'n' for new
CalType='iso'; % niso for not isolated, iso for isolated
DLPType='9';

shotlist  = 11700 + [108,110];
AddressType='s'; % s for standard, 'n' for new
