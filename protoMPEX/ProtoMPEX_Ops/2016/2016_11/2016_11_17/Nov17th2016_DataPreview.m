% This script is just for previewing the data during the experiment

close all
clear all

shotlist = 11400 + [199]; 
shotlist = 11500 + [121,123,125,126,131]; 
%shotlist = 11400 + [219]; 
shotlist = 9600 + [8,10,37,39,43,46,47];
shotlist = 9500 + [55,60,65,68,70,74,80,86,87,89];
shotlist = 9500 + [15,22,24,28,30,35];


% for shot 218 we have swapped int_4mm_1 for LP_V_Ramp, 
% shot 219 and after we put things back to where they were
