...
% the following shows different fueling regimes
% it suggests that the lowest pressure is 1 mTorr
% since we need to get lower than 1 mTorr within 0.5 sec
% this can be achieved with the upstream puffing and therefore motivates it
% use
shotlist = [11000 + [67,83,469],11922,13962]; 
% shotlist = [11000 + [67,83,469,470,471],11922]; 
