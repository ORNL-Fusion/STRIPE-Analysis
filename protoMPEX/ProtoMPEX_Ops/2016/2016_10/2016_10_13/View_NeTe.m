...
shotlist = 1e4 + [919];
shotlist = 9856
shotlist = 11400 + [21,22];
% shotlist = 13029
shotlist = [8813,8829];
shotlist =[10086,10099];
shotlist = [10141,10148];
...
address{1} = '\MPEX::TOP.MACHOPS1:PG4'; % Helicon signal
[PG,t_pg] = my_mdsvalue_v2(shotlist,address(1));

address{1} = '\MPEX::TOP.MACHOPS1:RF_FWD_PWR'; % Helicon signal
[Prf,t_prf] = my_mdsvalue_v2(shotlist,address(1));

% 9856 has low frequency oscillations
