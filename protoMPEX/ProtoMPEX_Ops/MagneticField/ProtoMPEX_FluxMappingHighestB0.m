...
z1D = linspace(z_Dump,4.75,300);

% Assignment of currents per power supply:
% =========================================================================
% Highest magnetic field cases in Proto-MPEX thus far:
% case 1:
coilCurrents{1}.TR1 = 0;
coilCurrents{1}.TR2 = 2500;
coilCurrents{1}.PS1 = 6800;
coilCurrents{1}.PS2 = 6300;
...
if ~strcmpi(confType,'conf_F')
    error('Change "confType" to config_F')
end
DrawVacuumVessel_Conf_F
