...
% coilCurrents{1}.TR2 = 2150;
% coilCurrents{1}.PS1 = 6937;
% coilCurrents{1}.PS2 = 3375;
% coilCurrents{1}.PS3 = 400;
% 
% % shot: 30279
% coilCurrents{2}.TR1 = 530;
% coilCurrents{2}.TR2 = 2150;
% coilCurrents{2}.PS1 = 2200;
% coilCurrents{2}.PS2 = 3375;
% coilCurrents{2}.PS3 = 400;

% shot: 30286
coilCurrents{3}.TR1 = 530;
coilCurrents{3}.TR2 = 2150;
coilCurrents{3}.PS1 = 2200;
coilCurrents{3}.PS2 = 1500;
coilCurrents{3}.PS3 = 400;
...
for ii = 1:numel(coilCurrents)
    dum1 = contour(z2D,r2D,B2D{ii},[1,1]*B_res);
    z_resLayer{ii} = dum1(1,2:end);
    r_resLayer{ii} = dum1(2,2:end);
end
%% SECTION 5: Plot data
...
for ii = 1:numel(coilCurrents)
    plot(z_resLayer{ii},+r_resLayer{ii},'r.')
    plot(z_resLayer{ii},-r_resLayer{ii},'r.')
end
