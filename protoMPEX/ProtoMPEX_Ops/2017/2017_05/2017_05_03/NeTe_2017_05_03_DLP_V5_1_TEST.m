...
switch sweep
    case 'niso'
% Testing vertical DLP 10.5
shotlist = 14200 + [58];
ChannelType = '2' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options
shotlist = 14200 + [59,60,61,62,63];
shotlist = 14200 + [65,66,67,70:73];
shotlist = 14200 + [86,88,91];
DLPType = '10MP'; % DLP 4.5 vertical
ChannelType = '1' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

shotlist = 14200 + [92,93,94,95];
DLPType = '6'; % DLP 4.5 vertical
ChannelType = '1' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

shotlist = 14200 + [96,97,98,99,100,101,102,104,106,107];
DLPType = '10MP'; % DLP 4.5 vertical
ChannelType = '1' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options
...
shotlist = 14200 + [52,53,55]; % DLP 4.5
DLPType = '4'; % DLP 4.5 vertical
ChannelType = '1' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

shotlist = 14200 + [56,57,58]; % DLP 1.5
DLPType = '1MP'; % DLP 1.5 horizontal
ChannelType = '1' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

shotlist = 14200 + [60]; % DLP 1.5
DLPType = '1MP'; % DLP 1.5 horizontal
ChannelType = '3' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

shotlist = 14200 + [61,62,63]; % DLP 1.5
shotlist = 14200 + [96,97]; % DLP 1.5
DLPType = '1MP'; % DLP 1.5 horizontal
ChannelType = '4' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

Config.tStart = 4.399; % [s]
Config.tEnd = 4.45;
