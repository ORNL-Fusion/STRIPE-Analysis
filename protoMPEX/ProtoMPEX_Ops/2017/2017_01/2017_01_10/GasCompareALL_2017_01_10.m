...
% 2017_01_10
shotlist = [11875,12000 + [651]];
shotlist = [11875,12000 + [651,713,715,873,891]];
shotlist = [11875,12000 + [651,713,715]];
% shotlist = [11875,12000 + [712,715],13962]; 
% shotlist = [11370,11473,11778,11875,12712,12715,13962,17559,17566,13027]; 

% Comparing upstream and downstream puffing with the same fueling rate
% 3.85s:1.21v, 4.1s:0.6v
% shotlist = [13027,12873,12891,12853]; 
% 13027, bodot probe XP with downstream fueling
% 12873, ICH+ECH experiment with upstream fueling

% some MAB like shots:
% shotlist = [13767,14233,11875];

% comparng upstream and downstream puffing
% shotlist = [15928,13962]
