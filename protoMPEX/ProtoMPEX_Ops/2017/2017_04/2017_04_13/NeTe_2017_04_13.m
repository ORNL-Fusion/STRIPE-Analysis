...
% re-establish conditions
shotlist = 13900 + [42,43,44,45,46,47];
% Long pulse 300 ms, helicon only:
shotlist = 13900 + [47,48,49,50,51];
% Long pulse 300 ms, reducing the 2nd puff
shotlist = 13900 + [47,51,52,53,54,55,56,57];
shotlist = 13900 + [47,54,57];
DLPType = '10MP';

% ========================================================================
% DLP 6.5 radial scan
shotlist = 13900 + [58,59,60,61,62,63 ,64  ];
r        =         [0 ,1 ,2 ,3 ,4 ,3.5,3.25];
DLPType = '6';
% ========================================================================
    % % ECH pulses, test pulse
    % shotlist = 13900 + [65,66,70,71];
    % DLPType = '10MP';
    % 
    % % Mach number measurement, no ECH
    % shotlist = 13900 + [71,72,73,76,77,78,79];
    % DLPType = '10MP';
    % shotlist = 13900 + [79,80,81,84];
    % DLPType = '10MP';
    % 
    % % ECH pulse timing scan
    % shotlist = 13900 + [85,86,87 ,88];
    % ts       =         [2,2 ,3.5, 3]; 
    % DLPType = '10MP';
    % 
    % % no ECH 
    % shotlist = 13900 + [70,86];
    % DLPType = '10MP';
    % 
    shotlist = 13900 + [105,106,107,108,109,110];
    ts       =         [2.5,2.5,2.0,1.5,1.5,1.0]; 
    
    shotlist = 13900 + [106,107,108,110];
    ts       =         [2.5,2.0,1.5,1.0]; 
    
    DLPType = '6';
    % 
%     shotlist = 13900 + [65,66];
%     DLPType = '10MP';
