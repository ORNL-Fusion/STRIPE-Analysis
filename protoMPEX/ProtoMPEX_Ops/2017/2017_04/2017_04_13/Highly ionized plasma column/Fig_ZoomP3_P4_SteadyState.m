...
Shotlist_Gas = [19862,19864];
Shotlist_Gas = [20116,20116];

GasCompare_SteadyState;

%% Test data
close all
C = {'k','b','g','m','c','k','b','g','m','c','k','b','g','m','c','k','b','g','m','c'}; ssqLevel = 0.001;
figure;
...
% 
% Lne = legend([hne1(s),hne2(s)],'$Conf.$ 1','$Conf.$ 2');
...
hpgB(2) = plot(TimeP-0.03,P{1}{2},'Parent',ax(n),'color','bl')
...
ax(n).YLabel.Rotation = 90; 
ax(n).YLabel.HorizontalAlignment = 'center'; ax(n).YLabel.VerticalAlignment = 'bottom';
hpgB(1) = plot(TimeP-0.03,(P{3}{1}+P{3}{2})/2 + 0.0,'Parent',ax(n),'color','k')
