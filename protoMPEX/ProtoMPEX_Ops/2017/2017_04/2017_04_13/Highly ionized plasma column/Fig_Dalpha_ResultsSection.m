...
%% Figure 6
close all
% t1 = 4.177; % the plasma is still evolving through a transient
t1 = 4.23;
t2 = 4.445;
...
set(axvid(3),'box','off','Visible','off')%
...
text(axvid(nax),20,630,'t = 4.23 s','Color','w','FontName','times','FontSize',11,'FontWeight','bold')
...
text(axvid(nax),0.68,0.5,'a)','Units','normalized','color','k','FontSize',12,'FontName','Times')
