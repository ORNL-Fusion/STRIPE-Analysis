...
ax(n).YGrid = 'on';
text(ax(n),0.02,0.8,'$DLP_A$','Units','normalized','Interpreter','latex','FontSize',10)
...
Lne.Box = 'off'; Lne.Location = 'Southwest';
ax(n).YGrid = 'on';
text(ax(n),0.02,0.8,'$DLP_B$','Units','normalized','Interpreter','latex','FontSize',10)
...
Lne.Box = 'off'; Lne.Location = 'Southwest';
ax(n).YGrid = 'on';
text(ax(n),0.02,0.8,'$DLP_C$','Units','normalized','Interpreter','latex','FontSize',10)
...
ax(n).YLabel.Rotation = 90; 
ax(n).YLabel.HorizontalAlignment = 'center'; ax(n).YLabel.VerticalAlignment = 'bottom';
hpgA(1) = plot(tpg2{1}(1:end-1),PG2{1},'Parent',ax(n),'color','k')
hpgA(2) = plot(tpg2{1}(1:end-1),PG2_GasOnly{1},'Parent',ax(n),'color','r')
ylim(ax(n),[-0.1,25])
ax(n).YGrid = 'on';
% LpgA = legend(hpgA,'w/ Plasma','no Plasma');
% LpgA.Interpreter = 'latex';
% LpgA.Box = 'off'; LpgA.Location = 'northwest';
text(ax(n),0.02,0.8,'$PG_A$','Units','normalized','Interpreter','latex','FontSize',10)
...
% LpgA.Interpreter = 'latex';
% LpgA.Box = 'off'; LpgA.Location = 'northwest';
text(ax(n),0.02,0.8,'$PG_B$','Units','normalized','Interpreter','latex','FontSize',10)
...
hpgB(2) = plot(tpg2{1}(1:end-1),PG3_GasOnly{1}*0.5,'Parent',ax(n),'color','r')
ylim(ax(n),[-0.05,4])
ax(n).YGrid = 'on';
...
ax(n).YLabel.Rotation = 90; 
ax(n).YLabel.HorizontalAlignment = 'center'; ax(n).YLabel.VerticalAlignment = 'bottom';
hpgB(1) = plot(tpg1{1}(1:end-1),PG1{1},'Parent',ax(n),'color','k')
hpgB(2) = plot(tpg1{1}(1:end-1),PG1_GasOnly{1},'Parent',ax(n),'color','r')
ylim(ax(n),[0,1.5])
ax(n).YGrid = 'on';
...
text(ax(n),0.02,0.8,'$PG_D$','Units','normalized','Interpreter','latex','FontSize',10)
