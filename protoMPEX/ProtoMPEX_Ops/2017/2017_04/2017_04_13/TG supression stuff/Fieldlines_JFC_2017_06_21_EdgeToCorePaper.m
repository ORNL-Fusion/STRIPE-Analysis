...
close all
% plasma_radius_cm = 1.8; %  Limiting at 600 A
plasma_radius_cm = 1.54; %  Limiting at helicon window, PRL paper conditions
% plasma_radius_cm = 1.8 ; % limiting at the antenna edge, PRL paper
% plasma_radius_cm = 1.52; % MAB conditions
plasma_radius_cm = 1.91; %  Limiting at helicon window, PRL paper conditions
...
contourf(zz,yy,B0,1./[2,2],'ShowText','off','Fill','Off','LineColor','c','LineWidth',2,'LineStyle','-')
