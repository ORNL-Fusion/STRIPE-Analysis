...
% shotlist = 13700 + [63,64];
% shotlist = 13700 + [64];
% shotlist = 13700 + [65]; % MachDLP probe, x = 0 cm
% shotlist = 13700 + [67]; % MachDLP probe, x = 0.5 cm
% shotlist = 13700 + [70,71,72]; % MachDLP probe, tprobe = 1.8 mm
shotlist = 13700 + [70]; % MachDLP probe,ECH shot

% shotlist = 13700 + [81,90,91,92]; % MachDLP, no magnets shot but ECH on
% 
% shotlist = 13700 + [81,82]; % no magnets shot but ECH on
% 
% shotlist = 13700 + [88,90,91,92]; % no magnets shot but ECH on

shotlist = 13700 + [88,89,90,91,92]; % TR2 = 160 A, PS1/2 = 4000 A, ECH ON

shotlist = 13700 + [81,82,84]; % TR2 = 160 A, PS1/2 = 4000 A, ECH ON

Config.tStart = 4.12; % [s]
Config.tEnd = 4.4;
...
% Config.tStart = 4.12; % [s]
% Config.tEnd = 4.3;
% shotlist = 13700 + [88]; % TR2 = 160 A, PS1/2 = 4000 A, RF FP, ECH ON
% shotlist = 13700 + [90]; % TR2 = 140 A, PS1/2 = 3500 A, RF FP, ECH ON
% shotlist = 13700 + [91]; % TR2 = 120 A, PS1/2 = 3000 A, RF FP, ECH ON
% shotlist = 13700 + [92]; % TR2 = 100 A, PS1/2 = 2500 A, RF trip, ECH ON
% shotlist = 13700 + [88,90,91,92]; % TR2 = 160 A, PS1/2 = 4000:500:2500 A, RF FP, ECH ON

% shotlist = 13700 + [81,90,91]; % TR2 = 160 A, PS1/2 = 4000:500:2500 A, RF FP, ECH ON
