% we have created this script to more in detail analyse the DLP 4.5 data
% taken during this day.
% We used the isolated sweep box. the channels for this probe are very
% prone to Glitches hence we need a dedicated script like this one to
% resolve the problem
...
DLPType = '4MP'; % DLP 1.5 horizontal
