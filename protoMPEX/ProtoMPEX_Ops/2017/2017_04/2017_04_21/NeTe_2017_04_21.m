...
shotlist = 14000 + [86,87,88,89,90];
DLPType = '10MP';

% DLP 4.5 experimetns
shotlist = 14000 + [91,92,93];
DLPType = '4MP';
Config.tStart = 4.37; % [s]
Config.tEnd = 4.43;

% Begin ECH experiments
shotlist = 14000 + [94,95,98,101,102];
DLPType = '10MP';
Config.tStart = 4.15; % [s]
Config.tEnd = 4.45;

% 250 ms pulses
shotlist = 14000 + [101,102,103,104,105,107];
DLPType = '10MP';
Config.tStart = 4.15; % [s]
Config.tEnd = 4.45;

% % gas test pulses
% shotlist = 14000 + [103,108,109,110,111,112,113,114,115,116,117,118,119];
% DLPType = '10MP';
% Config.tStart = 4.15; % [s]
% Config.tEnd = 4.45;
% 
% Good gas pulses
% shotlist = 14000 + [103,119];
% DLPType = '10MP';
% Config.tStart = 4.15; % [s]
% Config.tEnd = 4.45;
% 
shotlist = 14000 + [119,121];
DLPType = '10MP';
Config.tStart = 4.15; % [s]
Config.tEnd = 4.45;
% 
% shotlist = 14000 + [122,123];
% DLPType = '10MP';
% Config.tStart = 4.15; % [s]
% Config.tEnd = 4.45;

% % ECH on off high/low pressure
% shotlist = 14000 + [119,121,122,123];
% DLPType = '10MP';
% Config.tStart = 4.15; % [s]
% Config.tEnd = 4.45;
% 
% ICH testing shots:
% shotlist = 14000 + [128,126];
% DLPType = '10MP';
% Config.tStart = 4.15; % [s]
% Config.tEnd = 4.45;
% 
% continue with DLP4.5 scan
shotlist = 14000 + [130 ,131 ,132 ,133 ,134,135,136,138,141,142,144,146 ,147 ,148 ];
r =                [11.5,11.0,10.5,10.0,9.5,9.0,8.5,7.5,6  ,5  ,4.5,13.5,14.5,15.5];
shotlist = 14000 + [132]
DLPType = '4MP';
Config.tStart = 4.37; % [s]
Config.tEnd = 4.44;
...
switch DLPType 
    ...
    case '4MP'
        ...
        CalType='iso'; % niso for not isolated, iso is for isolated
end
