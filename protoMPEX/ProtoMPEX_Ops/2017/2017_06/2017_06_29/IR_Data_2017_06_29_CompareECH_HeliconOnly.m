...
% ECH ON
shot(1) = 15279;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_27';
% % ECH OFF
shot(2) = 15208;
% shot(2) = 15280;
a{2} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_27';
...
% ECH ON
shot(1) = 15061;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_15';
% % ECH OFF
shot(2) = 15062;
a{2} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_15';

% ECH ON
shot(1) = 15321;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_28';
% % ECH OFF
shot(2) = 15323;
a{2} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_28';

% June 28th 2017
% ECH pulses at 4.24 s
% ECH ON
shot(1) = 15355;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_28';
% % ECH OFF
...
% June 29th 2017, 
% First few shots after the N2 vent
% Compare last shot from yesterday and first today
shot(1) = 15381;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_28';
% % ECH OFF
shot(2) = 15410;
a{2} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_29';

% 4.5 kA case plasma
% Compare last shot from yesterday and first today
shot(1) = 15433; % 4 kA
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_29';
% % ECH OFF
shot(2) = 15435; % 4.5 kA
a{2} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_06_29';
