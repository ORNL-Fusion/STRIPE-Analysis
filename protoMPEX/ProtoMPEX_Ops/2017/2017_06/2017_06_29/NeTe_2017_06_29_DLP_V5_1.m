...
switch sweep
    case 'niso'
shotlist = [15000 + [312,315,319,402],14479];
% DLP 10.5 at the end of a TS scan and before going into the 4.5 kA case
shotlist = [15000 + [408,431,432,433,434]];
