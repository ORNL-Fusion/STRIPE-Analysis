...
switch sweep
    case 'niso'
shotlist = [15000 + [204,206,207,208,209,210,211], 14841];
shotlist = [15000 + [209,210,211,212,213]];


shotlist = [15000 + [209,212,213,214,215,217,218,220]];
shotlist = [15000 + [232,238]];

shotlist = [15000 + [232,238,278,286]];

% June 28th 2017
% First few DLP 10.5 shots
shotlist = [15000 + [310,311,312,313,314,315,316,318,319]];
shotlist = [15000 + [316,318,319,320]];

% change TR2 from 160 to 190 A
shotlist = [15000 + [320,321,322,323,325]];

shotlist = [15000 + [354,355]];
