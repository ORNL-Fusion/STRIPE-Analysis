...
% shotlist = 14600 + [201:202]; % DLP base shot from June 9th
% shotlist = 14600 + [207,215,222,244,257]; % Gas base shot from June 9th
% 
% shotlist = 14600 + [222,281];
% shotlist = 14600 + [222,282,283,284,285,319,323]; % with ECH
% shotlist = 14600 + [163]; % with ECH

% June 15th 2017
shotlist = 14900 + [70,71]; % Baratron calibration shots
shotlist = 14900 + [72]; % 1st plasma shot today
shotlist = 14600 + [202,280,372,376,378:380]; % Compare 1st plasma shot today with June 9th
shotlist = 14600 + [202,280,380,381,382]; % Compare 1st plasma shot today with June 9th
shotlist = 14600 + [202,280,382]; % Compare 1st plasma shot today with June 9th
shotlist = 14600 + [271,355,384]; % Compare 1st plasma shot today with June 9th

shotlist = 14600 + [385,386]; % 1st ECH pulse today
shotlist = 14600 + [228,288,385,386]; % Compare 1st ECH pulse today with yesterday and friday
shotlist = 14600 + [228,288,389,393]; % Compare 1st ECH pulse today with yesterday and friday
shotlist = 14600 + [228,288,389,393,436,438,439]; % bwgin chNGING ech timing

% shotlist = [15000 + [82,83,84,85,86],14802,14880]; % bwgin chNGING ech timing
shotlist = [14802, 15000 + [87,91,92,93,94,62,68]];

shotlist = [14803, 15000 + [62,68]];
shotlist = [14803, 15000 + [62,68,93,94,95,96]];

shotlist = [14803, 15000 + [62,94,95,97,98,100,101,103,104]];
shotlist = 15000 + [158,159,160:171];


DLPType = '10MP';
ChannelType = '1' ; % "1" for TARGET_LP,LP_V_RAMP, "2" for other options

Config.tStart = 4.175; % [s]
Config.tEnd = 4.45;
