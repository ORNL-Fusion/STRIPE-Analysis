...
% =========================================================================
% First few shots on 2017_12_08
shotlist = [18000 + [335,340,342]];
shotlist = [18000 + [343,345]];
% No ECH, no ICH,
% PS1 = 5200 A
shotlist = [18000 + [347]];
shotlist = [18000 + [352,353,360]];
shotlist = [18000 + [185,361,362]];
% PS1 = 5800 A
shotlist = [18000 + [362,363:367]];
shotlist = [18000 + [369,373]];
shotlist = 18399;
% shotlist = [18000 + [424,426,427]];
% shotlist = [18000 + [427,428]];
shotlist = [18000 + [431,432,433,434,436]];
shotlist = [18000 + [437]];
shotlist = [18000 + [447:451]];
shotlist = [18000 + [451,452]];
shotlist = [18000 + [429,435]];
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.14 & Ni{s}>0 & Ni{s}<1e21 & Te{s}<=20;
