...
% 2017_12_08
RemoveOffset = 0;
shotlist = 18000 + [182,355];
shotlist = 18000 + [429,435,529,530,531];
shotlist = 18000 + [1012,1013,1014];
shotlist = 18000 + [1014,1016,1017,1018,1019];

close all
TR2_filt =         ones(size(shotlist));
TR2_ffrm =         ones(size(shotlist))*35;
Calshot  =         ones(size(shotlist))*17928;
Calshot  =         ones(size(shotlist))*19006; % 2017_01_16
Calshot  =         ones(size(shotlist))*19015; % 2017_01_16
