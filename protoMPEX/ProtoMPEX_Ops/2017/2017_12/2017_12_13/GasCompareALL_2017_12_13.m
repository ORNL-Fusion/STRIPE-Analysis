...
% shotlist = [17691,17987,17996]

PressureInPascal = 0;
RemoveOffsetStartRF = 0;
...
for s = 1 :length(shotlist)
    P{1}{s} = (PG1{s}-PG1cal{1})*2*fctr;
    P{2}{s} = (PG2{s}-PG2cal{1})*2*fctr;
    P{3}{s} = (PG3{s}-PG3cal{1})*2*fctr;
    P{4}{s} = (PG4{s}-PG4cal{1})*10*fctr;
