...
% #########################################################################
save('PostProcessData_ne_vs_B0_2017_12_01.mat')
else
load('PostProcessData_ne_vs_B0_2017_12_01.mat')
end
...
for s = 1:length(shotlist)
    GoodFits{s} = GlitchFlag{s} == 0 & StdResNorm{s}<=0.081 & Ni{s}>0 & Ni{s}<1e21 & Te{s}<=4;
