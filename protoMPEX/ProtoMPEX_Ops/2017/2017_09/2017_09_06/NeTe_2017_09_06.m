...
% 1st DLP 10.5 shot of today, 2017_09_05
shotlist = [15942,16000 + [256,272,275,276,277,278,282]];
% 1st DLP 10.5 shot of today, 2017_09_06
shotlist = [15942,16000 + [282,283,284,285,286]];
shotlist = [15942,16000 + [287,288,292:296]];
shotlist = [15942,16000 + [295:297]];
shotlist = [15942,16000 + [309:314]];
shotlist = [15942,16000 + [318:324]];

% ICH pulses
shotlist = [15942,16000 + [322,330,332,333,338,343,351]];

shotlist = [15942,16000 + [355:361]];
shotlist = [15942,16000 + [361:363]];
shotlist = [15942,16000 + [363:364]];

% 2017_09_12
shotlist = [15942,16000 + [419]];
...
[ICH_fwd,t_ichfwd]   = my_mdsvalue_v2(shotlist,DA(1))
DA{1} = [RootAddress,'RF_REF_PWR'];
[ICH_rev,t_ichrev]   = my_mdsvalue_v2(shotlist,DA(1))
% #########################################################################
