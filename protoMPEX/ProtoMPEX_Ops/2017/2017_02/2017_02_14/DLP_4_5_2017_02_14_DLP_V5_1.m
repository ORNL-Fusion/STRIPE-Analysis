...
switch sweep
    case 'niso'
shotlist = 13000 + [165,166];
shotlist = 13000 + [252,253:255]; % DLP 6.5 plasma while DLP 4.5MP is on-axis
DLPType = '6';
...
Config.Center_I = 0; % Remove offset on I: 1 (yes) 0(no)
    ...
    case 'iso'
shotlist = 13000 + [181,252,253:255];
shotlist = 13000 + [181:185];
...
% #########################################################################
% [ni,Te,time,Ifit,Ip,Vp,tm,Vsweep,Isweep] = DLP_fit_V5_1_2017_02_14(Config,shotlist,DataAddress);
[ni,Te,time,Ifit,Ip,Vp,tm,Vsweep,Isweep,GlitchFlag,SSQres] = DLP_fit_V5_2_2017_02_14(Config,shotlist,DataAddress);
