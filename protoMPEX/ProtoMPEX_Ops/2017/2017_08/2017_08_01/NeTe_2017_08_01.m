...
% 1st DLP 10.5 shot of today, 2017_08_01
shotlist = 15000 + [856,858,859,860];
shotlist = 15000 + [862,863,864];
shotlist = 15000 + [865];

DLPType = '10MP';
Config.FitFunction = 2; 

% Using Target DLP #2 with niso sweep drive
shotlist = 15000 + [878:883,885];
% Using Target DLP #3 with niso sweep drive
shotlist = 15000 + [887,888,889,890,892];
shotlist = 15000 + [892,890,893];
shotlist = 15000 + [893,894,895,896];
% Using Target DLP #2 with niso sweep drive and PS1 = 4500 A
shotlist = 15000 + [896];
...
% DLP 10.5
shotlist = 15000 + [897, 898, 899];
% TR2 = 300 A
shotlist = 15000 + [900,901,902];
% TR2 = 270 A 
shotlist = 15000 + [903,904,905];
shotlist = 15000 + [906,907,909];
shotlist = 15000 + [909,910,911];

% DLP 10.5
shotlist = 15000 + [928,929,933,935,942,943];
...
Config.Center_I = 1; % Remove offset on I: 1 (yes) 0(no)
    ...
    case 'B'
        shotlist = 15000 + [969,970];
        shotlist = 15000 + [971,974];
