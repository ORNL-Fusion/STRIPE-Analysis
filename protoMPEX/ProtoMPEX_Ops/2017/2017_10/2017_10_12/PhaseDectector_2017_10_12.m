...
shot = 16000 + [858,859,860];
% 180 degree phase shift
shot = 16000 + [863,864];
% Radial scan
shot = 16000 + [852,859,860,861,862,863,865];
shot = 16000 + [860,861,862,863,865,867,868 ,869];
R    =         [15 ,14 ,13 ,12 ,11 ,11 ,11.5,11.5];

% The SAIREM transmitter behaved well today for the exception of the trips
% that would discable the tranmitter. these initial results show that this
% new single loop probe does effectively reject  electrostatic signals
% (180 degree test) both on-axis and at the edge. also the shots are very
% reproduceable
% The DLP data shows that as the bdot probe moves deeper into the plasma
% the gas pressure goes up and ne goes down at spool 4.5.
% However, the results suggests that a 0.25 cm resolution scan is possible
% in a single day.
