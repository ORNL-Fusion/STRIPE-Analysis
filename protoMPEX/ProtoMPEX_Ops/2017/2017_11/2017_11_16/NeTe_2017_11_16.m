...
% shotlist = 17500 + [36,54,58,59,61,62,63];
% shotlist = 17500 + [36,59,62,63,66,73,74];
% % Compare 1st piezo electric puffer shot with MFC
% shotlist = 17500 + [36,54];
% shotlist = 17500 + [54,55,56,59];
% shotlist = 17500 + [36,58,59];
% shotlist = 17500 + [60,61,62];
% shotlist = 17500 + [36,59,66];
% shotlist = 17500 + [36,66,75];
% shotlist = 17500 + [119];
% % shotlist = 17500 + [75,80,81];

shotlist = 17000 + [647,714,720,722,726];
shotlist = 17000 + [731,732,734,736];
shotlist = 17000 + [736,737,739,740];
shotlist = 17000 + [670,739,740];

shotlist = 17000 + [634,759,760];

% This shot shows really strong ripple
shotlist = 17000 + [705,739];

% 
shotlist = 17000 + [763,764,765,766,767];

% DLP scan no uW
shotlist = 17000 + [693,767];
% Begin DLP scan with uW
shotlist = 17000 + [766:769,772,774:777];

% Shot at Ps1/2 = 4500 A
shotlist = 17000 + [778];
% shotlist = 17000 + [619];

shotlist = 17000 + [827,828];
shotlist = 17000 + [672,674];
