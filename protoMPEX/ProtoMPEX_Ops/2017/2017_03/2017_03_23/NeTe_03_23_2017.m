...
% 1st ECH + stable plasma at 200 ms pulse 
shotlist = 13000 + [480,481];
% ECH + plasma, 250 ms
shotlist = 13000 + [488,489];
% ECH + plasma, 300 ms
shotlist = 13000 + [490,495];


% shotlist = [12873,12962, 13000 + [465]];

% shotlist = [11471,11475];
...
%     plot(time{s},ni{s}{2},C{s},'lineWidth',1);
    ...
    hold on
    plot(t_ech{s}(1:length(ECH{1})),ECH{s}*1e19,C{s},'lineWidth',0.5)
end
