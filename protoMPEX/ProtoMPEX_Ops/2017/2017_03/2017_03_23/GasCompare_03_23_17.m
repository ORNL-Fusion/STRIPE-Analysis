...
[a,t0L] = my_mdsvalue_v2([12975],address(1));
[b,~] = my_mdsvalue_v2([13436],address(1));
PG0L{1} = a{1} - b{1};
% We do not have a calibration shot for the above (12975) however, we took
% a 5500 A shot 13436 on MArch 21st 2017 
...
plot(t0L{1}(1:length(PG0L{1})),(PG0L{1}-0*mean(PG0L{1}(1:200)))*f + 0*offset(1),'g','LineWidth',2)
