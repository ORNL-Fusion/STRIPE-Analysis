...
% 1st puff Gas scan
shotlist = 13500 + [99,100,102,103,104,105,106,108,109,110,111,115,116];
level   =          [91,95 ,99 ,115,122,130,140,150,160,170,200,250,270]/100;

% shotlist = 13500 + [99,115,116];
...
h = errorbar(level,ne1,dne1,'ro-','LineWidth',1)
h = errorbar(level,ne0,dne0,'ko-','LineWidth',1); 
ylim([0,3]*1e19)
xlim([0.5,3]); 
box on
...
h = errorbar(level,Te1,dTe1,'ro-','LineWidth',1)
h = errorbar(level,Te0,dTe0,'ko-','LineWidth',1)
ylim([0,3])
xlim([0.5,3]); 
box on
