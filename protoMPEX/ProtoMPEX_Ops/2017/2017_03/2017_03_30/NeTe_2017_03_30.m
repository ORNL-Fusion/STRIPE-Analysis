...
shotlist = 13700 + [3,4,5,6,7]
% shotlist = 13600 + [56,57,62,63,68,69]
% shotlist = 13600 + [71,72,81];
% shotlist = 13600 + [73,74]; % lowest drop on ne
% shotlist = 13600 + [35:38] ; % 85 kW cases

% shotlist = 13600 + [60,61];
shotlist = 13600 + [62,63]

% shotlist = 13400 + [80,81];
% 
% % March 31st 2017 operations
% shotlist = 13700 + [40,41,42,43]

% TR2 = 100 A, increase in PS1/PS2
shotlist = 13600 + [56,59,60,71]
PS1 =              [40,45,47,49]*100;

% At PS1/2 = 4900, increase TR2 = 160
shotlist = 13600 + [72,73,74]

% at TR2 = 160, scan PS1/2
shotlist = 13600 + [84,85,86,88]
% PS1 =              [

% Global field scan
shotlist = 13600 + [88,86,85,56,59,60,71] 
PS1      =         [25,30,35,40,45,47,49];
TR2      =         [10,12,14,10,10,10,10]*10;

shotlist = 13600 + [54,55]
shotlist = 13600 + [66,67]
