% Created by JF Caneses, 2017_07_05
% Compare 4 shots at most
...
% shotlist = 15400 + [96   ,97   ,131   ,132  ];
% TR2_filt =         [1    ,1    ,1    ,1    ];
% TR2_ffrm =         [15   ,15   ,15   ,15   ];
% Calshot  =         [15460,15460,15460,15460];
% PGcenter =         [];
% tubes    = []; % choose 4 tubes at most


shotlist = 15400 + [101  ,161  ,164  ,165  , 86   ];
shotlist = 15000 + [565  ,566  ,567  ,572  , 573 ];
% close all
TR2_filt =         [1    ,1    ,1    ,1    ,1    ];
TR2_ffrm =         [15   ,15   ,15   ,15   , 15  ];
Calshot  =         [15460,15460,15460,15460,15460];
PGcenter =         [];
tubes    = []; % choose 4 tubes at most


shotlist = 15000 + [572  , 573 , 575 , 576 , 577];
% close all
TR2_filt =         [1    ,1    ,1    ,1    ,1    ];
TR2_ffrm =         [15   , 15  ,15   ,15   ,15   ];
Calshot  =         [15460,15460,15460,15460,15460];
...
shotlist = [15000 + [602,576,577,432] , 13929]
% close all
TR2_filt =         [1    ,1    ,1    ,1    ,1    ];
TR2_ffrm =         [15   , 15  ,15   ,15   ,15   ];
Calshot  =         [15460,15460,15460,15460,15460];
...
shotlist = [15000 + [597,598,602,608,614,623]]
close all
TR2_filt =         [1    ,1    ,1    ,1    ,1    ,1];
TR2_ffrm =         [15   , 15  ,15   ,15   ,15   ,15];
Calshot  =         [15460,15460,15460,15460,15460,15460];
PGcenter =         [];
tubes    = []; % choose 4 tubes at most

% =========================================================================
% Compare the 4.5 kA case with the 4.0 kA case
shotlist = [15000 + [413,649,650,651,652,653]]
close all
TR2_filt =         [1    ,1    ,1    ,1    ,1    ,1];
TR2_ffrm =         [15   , 15  ,15   ,15   ,15   ,15];
Calshot  =         [15405,15460,15460,15460,15460,15460];
PGcenter =         [];
tubes    = []; % choose 4 tubes at most
% =========================================================================
