...
% #########################################################################
helicon_current = 160;
current_A = 3500; % coils near source
current_B = 5500; % coils near target
current_C = 600;


helicon_current = 160;
current_A = 4500; % coils near source
current_B = 4500; % coils near target
current_C = 600;

% helicon_current = 80;
% current_A = 2500; % coils near source
% current_B = 2500; % coils near target
% current_C = 600;
