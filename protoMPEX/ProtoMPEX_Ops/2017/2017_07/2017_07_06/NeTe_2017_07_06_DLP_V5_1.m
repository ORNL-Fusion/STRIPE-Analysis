...
switch sweep
    case 'niso'
        ...
        % 1st DLP 10.5 shot of today, July 5th 2017
shotlist = 15000 + [472,476,477,478,481,482];
shotlist = 15000 + [482,483,484,485,486,487,488];

        % 1st DLP 10.5 shot of today, July 6th 2017
shotlist = 15000 + [561,562,563,564,565,488];
% Lowering the TR1 and TR2
shotlist = 15000 + [565,566,567,568,569,570,571];

shotlist = 15000 + [575,576,577,431,432];

% Strange gas behaviour
shotlist = 15000 + [572];
