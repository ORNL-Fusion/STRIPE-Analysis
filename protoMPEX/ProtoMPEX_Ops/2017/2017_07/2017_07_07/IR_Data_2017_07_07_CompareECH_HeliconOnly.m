...
% ECH OFF, 
shot(1) = 15676;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_07_07';
% % ECH ON
shot(2) = 15677;
a{2} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_07_07';

% we began seeing a large decrease in the gas pressure at spool 2.5
% ECH ON, 
shot(1) = 15698;
a{1} = '\\mpexserver\ProtoMPEX_Data\IR_Camera\2017_07_07';
% % ECH ON, no probe
