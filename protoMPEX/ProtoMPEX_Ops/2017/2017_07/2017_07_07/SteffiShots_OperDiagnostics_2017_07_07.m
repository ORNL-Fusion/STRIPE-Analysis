...
% July 5th: ===============================================================
% Start of 4.5 kA case on July 5th
shotlist = [15000 + [474, 486, 488] ];
% Random shots from the TS ensemble
shotlist = [15000 + [474, 486, 488, 534, 558] ];
TR2_filt =         ones(size(shotlist));
TR2_ffrm =         ones(size(shotlist))*15;
Calshot  =         ones(size(shotlist))*15460;
PGcenter =         [];
tubes    = []; % choose 4 tubes at most

% July 6th: ===============================================================
% Start of 4.5 kA case on July 6th, strange gas behavior
shotlist = [15000 + [563:568,571,572,594] ];
% Change of match changes the strange gas behavior, 
shotlist = [15000 + [649:653] ];
TR2_filt =         ones(size(shotlist));
TR2_ffrm =         ones(size(shotlist))*15;
Calshot  =         ones(size(shotlist))*15460;
PGcenter =         [];
...
% July 7th: ===============================================================
% First few shots with unusual gas pumping 
shotlist = 15000 + [657,658,659];
% change in the gas pumping
shotlist = 15000 + [672:680,688];
% Requested by Steffi, with Probes in
shotlist = 15000 + [697 ,698  ,703 ,706 ];
% Requested by Steffi, with Probes OUT
shotlist = 15000 + [699:702];
...
% % Typical 4 kA shots:
% shotlist = [15000 + [312, 315, 319, 320, 422, 423], 14479];
% 
% % Shots requested by Steffi
% shotlist = [15000 + [697,698,699,700,701,703,704,705,706]];
