...
% 1st DLP 10.5 shot of today, July 7th 2017
shotlist = 15000 + [657,658,659];
% % Begin the Global field scan 
% shotlist = 15000 + [659 ,662 ,663 ,664 ,665 ,666 ,668 ,669 ];
% PS12     =         [4000,4250,4500,4500,4500,4500,4750,4750];
% ECH      =         [0   ,0   ,0   ,1   ,1   ,1   ,0   ,1   ];
% close all
% 
% shotlist = 15000 + [669 ,670 ,671 ,672 ,673 ,697];
% PS12     =         [4750,4750,5000,5000,5000];
% ECH      =         [1   ,1   ,0   ,1   ,1   ];
% close all
...
% =========================================================================
% using isolation box
shotlist = 15000 + [676 ,677 ,678 ,679 ,680 ,681 ,682 ,683 ,684 ];
PS12     =         [5250,5250,5250,5250,5500,5500,5500,5750,5750];
ECH      =         [0   ,1   ,1   ,1   ,0   ,1   ,1   ,0   ,1   ];
close all
% 
% shotlist = 15000 + [683 ,684 ,686 ,688 ,691 ,693 ,694 , 697];
% PS12     =         [5750,5750,4250,4250,4250,4250,4250,4250];
% ECH      =         [0   ,1   ,0   ,0   ,0   ,1   ,0   ,0   ];
% close all
% 
% shotlist = 15000 + [697 ,698  ,703 ,706 ];
% PS12     =         [4250,4250 ,5250,5250];
% ECH      =         [0   ,1   ,1   ];
% close all
%=========================================================================
%=========================================================================
