...
% =========================================================================
% Last few shots yesterday testing the effect of the match point
...
% =========================================================================
% First few shots on July 7th 2017
shotlist = [15000 + [652,653,655,656,657]]
close all
TR2_filt =         [1    ,1    ,1    ,1    ,1    ,1];
TR2_ffrm =         [15   , 15  ,15   ,15   ,15   ,15];
Calshot  =         [15405,15460,15460,15460,15460,15460];
...
tubes    = []; % choose 4 tubes at most
% =========================================================================
% Comparing gas only shots,

% =========================================================================
% Begin global field scan 
shotlist = [15000 + [659,662,663,664,665,666,668,669,670,671,672,673,675,677,678,680,681,683,684,685,688]];
shotlist = [15000 + [659,662,686,687,688,691,693,696,697,698,699,700]];
shotlist = [15000 + [697,698,699,700,701,703,706]];
