...
shotlist = 15000 + [710:716];
% shotlist = 15000 + [712,716,717,718,719];
% shotlist = 15000 + [718,719,720];
% shotlist = 15000 + [722];
% shotlist = 15000 + [730,731,736,737,738];
% shotlist = 15000 + [757];
% shotlist = 15000 + [758];
...
% #########################################################################
DA{1} = [RootAddress,'INT_2MM_1']; % Isx
[f1,t_f1]   = my_mdsvalue_v2(shotlist,DA(1))
DA{1} = [RootAddress,'INT_4MM_2']; % Isx
[f2,t_f2]   = my_mdsvalue_v2(shotlist,DA(1))
figure; hold on; 
plot(t_f1{1}(1:end-1),1000*f1{1}/10);
plot(t_f2{1}(1:end-1),1000*f2{1}/10,'r'); ylim([-50,50])
% return
% #########################################################################
