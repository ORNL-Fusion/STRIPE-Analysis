...
for kk = shotsToAnalyze
    ...
    % Save figure:
    figureName = ['Step_1b_FourierRepresentation_',num2str(round(PS3(kk))),'_A_',num2str(shot(kk))];
...
for kk = shotsToAnalyze
    ...
    % Save figure:
    figureName = ['step_1b_HeatFluxMap_',num2str(round(PS3(kk))),'_A_shot_',num2str(shot(kk))];
    ...
    % Save figure:
    figureName = ['step_1b_IntegratedPower_',num2str(round(PS3(kk))),'_A_shot_',num2str(shot(kk))];
    saveas(gcf, figureName,'tiff')
end
