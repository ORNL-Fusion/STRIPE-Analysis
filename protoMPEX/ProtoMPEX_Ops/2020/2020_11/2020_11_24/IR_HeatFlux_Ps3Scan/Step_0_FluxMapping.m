...
switch shotType
    ...
    coilCurrents{ii}.TR2 = 1500;
    coilCurrents{ii}.PS1 = 3000;
    coilCurrents{ii}.PS2 = 3000;
    coilCurrents{ii}.PS3 = 220;
    
    ii = 2;
    coilCurrents{ii}.TR1 = 530;
    coilCurrents{ii}.TR2 = 1705;
    coilCurrents{ii}.PS1 = 3409;
    coilCurrents{ii}.PS2 = 3409;
    coilCurrents{ii}.PS3 = 250;

    ii = 3;
    coilCurrents{ii}.TR1 = 530;
    coilCurrents{ii}.TR2 = 1875;
    coilCurrents{ii}.PS1 = 3750;
    coilCurrents{ii}.PS2 = 3750;
    coilCurrents{ii}.PS3 = 275;
    
    ii = 4;
    coilCurrents{ii}.TR1 = 530;
    coilCurrents{ii}.TR2 = 2045;
    coilCurrents{ii}.PS1 = 4091;
    coilCurrents{ii}.PS2 = 4091;
    coilCurrents{ii}.PS3 = 300;
    
    ii = 5;
    coilCurrents{ii}.TR1 = 530;
    coilCurrents{ii}.TR2 = 2216;
    coilCurrents{ii}.PS1 = 4432;
    coilCurrents{ii}.PS2 = 4432;
    coilCurrents{ii}.PS3 = 325;    
...
% end
DrawVacuumVessel_Conf_G_SinWindow
...
% Flux lines:
lineColor = {'k','r','g','bl','m','c','k','r','g','bl','m','c'};
for ii = 1:numel(coilCurrents)
