...
switch ShotType
    case 1
        ...
        shotlist = [30000 + [945,946,947,948,949,951]]; 
        shotlist = [30000 + [932,952:955]]; 
        DLPType = '1MP';
    case 2 % DLP 1.5 Radial scan:
        shotlist = [30000 + [932 ,933 ,934 ,935 ,936 ,937,938,939,940 ,941 ,942 ,943 ,944 ,945 ,946 ,947 ,948 ,949  ,951  ]]; 
        R        =          [12.0,11.5,11.0,10.5,10.0,9.5,9.0,8.5,8.25,8.75,12.5,13.0,14.0,14.5,15.0,15.5,16.0,15.75,15.25];
        DLPType = '1MP';        
    case 3
       shotlist = [30000 + [964,965,967,969 ]];
       R        =          [8.5,8.0,7.0,10.5];
        DLPType = '6MP';
    case 4
        shotlist = [30000 + [952,991:992],29027];
        DLPType = '12MP';
    case 5
        shotlist = [30000 + [980]];
        DLPType = '6MP';
...
Config.tEnd = Config.tStart + 0.75;
