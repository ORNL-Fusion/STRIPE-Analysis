...
switch ShotType
    case 1
        shotlist = [30000 + [854,895,891,916]]; 
        DLPType = '1MP';
    case 2
        shotlist = [30000 + [901,902,903,904,905,906,908,909,911]]; 
        PS1 =               [3.5,4.0,4.5,5.0,5.5,6.0,6.0,3.0,2.0];
        PS3 =               [220,220,220,220,220,220,160,220,220];
        DLPType = '12MP';
    case 3
        shotlist = [30000 + [921]]; 
        DLPType = '6MP';        
...
switch DLPType 
    ...
    case '6MP'
        ...
        Config.L_tip = 2.0/1000; % 2.0 as of 2020_11_12
        Config.D_tip = 0.254/1000; % [m]
    case '10'
        DLP = 10.5;
...
%         Config.L_tip = 1.6/1000;% according to Nischal 2017_11_21
    ...
    case '12MP';
        ...
        Config.L_tip = 2.0/1000; % As of 2020_11_12 
        Config.D_tip = 0.254/1000; % [m]
   case '8MP';
        DLP = 8.5;
        Config.L_tip = 2/1000;
