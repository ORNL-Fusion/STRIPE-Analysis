...
case 1
    ...
    coilCurrents{1}.TR2 = 2500;
    coilCurrents{1}.PS1 = 6800;
    coilCurrents{1}.PS2 = 2000;
    coilCurrents{1}.PS3 = 400;

%     % case 1:
%     coilCurrents{2}.TR1 = 530;
%     coilCurrents{2}.TR2 = 2500;
%     coilCurrents{2}.PS1 = 3500;
%     coilCurrents{2}.PS2 = 3500;
...
case 2
    ...
    coilCurrents{3}.PS2 = 1700;
    coilCurrents{3}.PS3 = 650;
    
    % case 4:
    coilCurrents{4}.TR1 = 530;
    coilCurrents{4}.TR2 = 2500;
    coilCurrents{4}.PS1 = 2500;
    coilCurrents{4}.PS2 = 1700;
    coilCurrents{4}.PS3 = 500;
case 3
    % case 1:
    coilCurrents{1}.TR1 = 530;
    coilCurrents{1}.TR2 = 2500;
    coilCurrents{1}.PS1 = 2500;
    coilCurrents{1}.PS2 = 1700;
    coilCurrents{1}.PS3 = 500;
case 4
    % case 1:
    coilCurrents{1}.TR1 = 530;
    coilCurrents{1}.TR2 = 2500;
    coilCurrents{1}.PS1 = 2500;
    coilCurrents{1}.PS2 = 450;
    coilCurrents{1}.PS3 = 500;
case 5
    % case 1:
    coilCurrents{1}.TR1 = 530;
    coilCurrents{1}.TR2 = 2500;
    coilCurrents{1}.PS1 = 2000;
    coilCurrents{1}.PS2 = 3500;
    coilCurrents{1}.PS3 = 550;
    
   % case 2:
    coilCurrents{2}.TR1 = 530;
    coilCurrents{2}.TR2 = 2500;
    coilCurrents{2}.PS1 = 2500;
    coilCurrents{2}.PS2 = 3500;
    coilCurrents{2}.PS3 = 550;
end
...
% =========================================================================
figureName = 'ProtoMPEX_FluxMappingHighestB0';
...
% =========================================================================
figureName = 'ProtoMPEX_BzProfileHighestB0';
figure('color','w','Tag',figureName)
hold on
for ii = 1:numel(coilCurrents)
