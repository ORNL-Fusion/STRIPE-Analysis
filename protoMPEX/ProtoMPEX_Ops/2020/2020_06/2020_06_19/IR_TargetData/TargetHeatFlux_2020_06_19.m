...
rotate_flag = 1;
switch xp
    case 312 % DLP 6.5, rgauge = 2 cm; 19 MWm-2
        shot       = 30000 + [312];
        addressLoc =         [  1];

   case 313 % DLP 6.5, rgauge = 2 cm; Raised PS2: 12 MWm-2
        shot       = 30000 + [313];
        addressLoc =         [  1];

   case 314 % DLP 6.5, rgauge = 5.0 cm: 15 MWm-2
        shot       = 30000 + [314];
        addressLoc =         [  1];
        
   case 315 % DLP 6.5, rgauge = 5.5 cm: 15 MWm-2
        shot       = 30000 + [315];
        addressLoc =         [  1];
        
   case 316 % DLP 6.5, rgauge = 6.0 cm: 14.0 MWm-2
        shot       = 30000 + [316];
        addressLoc =         [  1];
        
   case 318 % DLP 6.5, rgauge = 6.5 cm: 12.5 MWm-2
        shot       = 30000 + [318];
        addressLoc =         [  1];
        
   case 320 % DLP 6.5, rgauge = 7.0 cm: 10.0 MWm-2
        shot       = 30000 + [320];
        addressLoc =         [  1]; 
        
   case 323 % DLP 6.5, rgauge = 7.0 cm, shattered probe:  13.5 MWm-2
        shot       = 30000 + [323];
        addressLoc =         [  1]; 
        
   case 15 % Rod -> rp = 3.5 cm:
        shot       = 30000 + [331];
        addressLoc =         [  1];
        maxFr = 146; 
        
   case 16 % Rod -> rp = 2.5 cm:
        shot       = 30000 + [332];
        addressLoc =         [  1];
        maxFr = 146; 
        
   case 333 % Rod -> rp = 2.5 cm:
        shot       = 30000 + [333];
        addressLoc =         [  1];
        
   case 334 % Rod -> rp = 1.5 cm: 14.5 MWm-2
        shot       = 30000 + [334];
        addressLoc =         [  1];
        
   case 335 % Rod -> rp = 1.0 cm: 16 MWm-2
        shot       = 30000 + [335];
        addressLoc =         [  1];

   case 336 % Rod -> rp = 1.0 cm + Na detector in control room : 16 MWm-2
        shot       = 30000 + [336];
        addressLoc =         [  1];
end
...
% =========================================================================
a{1} = cd;
a{6} = ['C:\Users\nfc\Documents\ProtoMPEX_Ops\2020\2020_06\2020_06_19'];
...
% for r = 120:1:144;
for r = (fr - 20):1:fr
    %     zz = (q_IJR(:,:,r) + q_IJR(:,:,r+1) + q_IJR(:,:,r+3))/3  -  0*q_IJR(:,:,160); 
    zz = q_IJR(:,:,r)  -  1*q_IJR(:,:,160); 
