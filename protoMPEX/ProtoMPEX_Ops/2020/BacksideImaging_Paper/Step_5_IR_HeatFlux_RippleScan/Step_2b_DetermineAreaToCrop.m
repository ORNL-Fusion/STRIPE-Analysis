...
shot          = [29778,29775,29771];
PS2_current  =  [1630 ,2360 ,3370 ];
...
if plotFig_1
    ...
    for kk = shotlist
        ...
        legendText{kk} = ['kk = ',num2str(kk),', ',num2str(shot(kk)),', PS2: ',num2str(PS2_current(kk)),' [A]'];
    end
...
for kk = shotlist
    ...
    if kk == numel(shotlist)
        hC = colorbar;
        set(hC,'Position',[0.1424    0.1325    0.0111    0.1476])
...
%% Save data:
if saveData
    varList = {'shot','PS2_current','seq','dT','t_dT','intf_c'};
