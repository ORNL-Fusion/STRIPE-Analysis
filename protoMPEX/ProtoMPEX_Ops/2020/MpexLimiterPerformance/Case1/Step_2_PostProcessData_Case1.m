...
box on
grid on
ylabel('$n_e$ $\times$ $10^{19}$ [m$^{-3}$]','Interpreter','latex','FontSize',13);
xlabel('t [s]','Interpreter','latex','FontSize',13);
title('Target','Interpreter','latex','FontSize',11)
...
legendText{4} = ['RF end'];
hLeg = legend([hte,hLs,hLe],legendText);
set(hLeg,'Interpreter','Latex','FontSize',10,'Location','best','Box','on')
title('Target','Interpreter','latex','FontSize',11)

% Save figure:
figureName = 'Step_2_NeTe';
...
legendText{3} = ['RF start'];
legendText{4} = ['RF end'];
hLeg = legend([hpg4,hLs,hLe],legendText);
set(hLeg,'Interpreter','Latex','FontSize',10,'Location','best')
title('Plasma source','Interpreter','latex','FontSize',11)
...
ylabel('[Pa]','Interpreter','latex','FontSize',13);
xlabel('t [s]','Interpreter','latex','FontSize',13);
title('Electron heating section','Interpreter','latex','FontSize',11)

% Save figure:
figureName = 'Step_2_NeutralPressure';
saveas(gcf,figureName,'tiffn')
