...
%         shot       = 29000 + [715];
    ...
    case 4 % ECH shot, highest heat flux
        shot       = 29000 + [653];
        addressLoc =         [  2];
    case 5 % Data from 2020_04_08
        shot       = 29000 + [778];
        addressLoc =         [  2];
    case 6 % Data from 2020_04_09
        shot       = 29000 + [819];
        addressLoc =         [  3];
    case 7 % Data from 2020_04_159
        shot       = 29000 + [655];
        addressLoc =         [  1];
    case 8 % Data from 2020_06_19
        shot       = 30000 + [323];
        addressLoc =         [  6];
    case 9 % Data from 2020_03_30
        shot       = 29000 + [648];
        addressLoc =         [  1];        
end
...
a{1} = cd;
a{2} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_03_30'];
a{3} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_04_09'];
a{4} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_04_15'];
a{5} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_06_19'];
...
% for r = 120:1:144;
for r = [40:4:144,fr]
%     zz = (q_IJR(:,:,r) + q_IJR(:,:,r+1) + q_IJR(:,:,r+3) + + q_IJR(:,:,r+4))/4  -  0.3*q_IJR(:,:,160); 
     zz = q_IJR(:,:,r)  -  0*q_IJR(:,:,160); 
