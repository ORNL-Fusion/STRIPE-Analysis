...
% =========================================================================
a{1} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_02_27'];
...
for s = 1:length(shot)
    ...
    % Crop data:
    for ii = 1:size(g{s},3)
%         f{s}(:,:,ii) = g{s}(:,100:400,ii);
        f{s}(:,:,ii) = g{s}(:,130:600,ii);        
    end
