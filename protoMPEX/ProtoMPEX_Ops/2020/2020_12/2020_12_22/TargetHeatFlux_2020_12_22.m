...
% =========================================================================
a{1} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_12_22'];
a{2} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2021_01_15'];
a{2} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2021_02_11'];
...
% for r = 120:1:144;
for r = [90:1:160,fr]
    zz = (q_IJR(:,:,r) + q_IJR(:,:,r+1) + q_IJR(:,:,r+3) + q_IJR(:,:,r+4))/4; 
%     zz = q_IJR(:,:,r); 
