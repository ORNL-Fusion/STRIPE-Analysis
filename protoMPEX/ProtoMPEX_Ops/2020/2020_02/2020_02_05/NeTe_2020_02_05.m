...
switch ShotType
    case 1     
        shotlist = [28000 + [693,694,915]];    
        % Top view:
        shotlist = [28000 + [914,915,916,917,918,919,920,921]];      
%         Middle view:
%         shotlist = [28000 + [930,931,932,933,934]];   
%         Bottom view gas scan:
%         shotlist = [28000 + [926,935]];   
%         Josh XPs:
%         shotlist = [28000 + [851,938,940,941,942,943]];  
%         shotlist = [28000 + [851,943,944,945]];  
%         shotlist = [28000 + [851,949,950]];  
%         % Upstream limit
%         shotlist = [28000 + [960,962,963,964]];         
%         shotlist = [28000 + [967,968,969,971]];  
        
%         shotlist = [28405,29000 + [27,28,31]];         
    case 2     
         % Bottom view:
         shotlist = [28000 + [923,924,925,926,927,928,929]];
    case 3 
end
