...
switch ShotType
    case 1                                                           
        shotlist = [29000 + [100,146,169,170]];                                 
        shotlist = [29000 + [146,170,171,172]]; 
        shotlist = [29000 + [146,171,172,173]];                                 
    case 2     
        shotlist = [29000 + [127,128,174,175]];                                 
        shotlist = [29000 + [127,176,177,178]];                                 
        shotlist = [29000 + [127,128,179,180]];                                         
        shotlist = [29000 + [182,184]];                                         
    case 3
        shotlist = [29000 + [175,182,182]];  
        shotlist = [28000 + [396]]; 
        shotlist = [28000 + [424,427,428]]; 
        shotlist = [28000 + [423,424]]; 
        shotlist = [28000 + [415,423,424]]; 
        shotlist = [28000 + [308,424]]; 
end
