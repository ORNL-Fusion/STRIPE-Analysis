...
switch xp
    case 1        
        ...
        viewType   = ''; 
    case 2
        shot       = 28000 + [892,893,894,896,897];
        rfPwrNet   =         [127,112,95 ,74 ,75 ];
        addressLoc =         [1  ,1  ,1  ,1  ,1  ];
        viewType   = 'Bottom'; 
        
    case 3    
        shot       = 28000 + [899,900,901,902,903];
        rfPwrNet   =         [86 ,104,109,123,66 ];
        addressLoc =         [1  ,1  ,1  ,1  ,1];
        viewType   = 'Middle'; 
%         
%         shot       = 28000 + [905];
...
% =========================================================================
a{1} = [cd,'\IR_Data'];
a{1} = ['\\mpexserver\ProtoMPEX_Data\IR_Camera\2020_02_04'];
...
for fr = 66; %1:1:size(intensity{s},3)
