...
switch ShotType
    case 1   
%         shotlist = [28000 + [693,871,872,873]];    
        shotlist = [28000 + [885,886,890,891]];    
%         shotlist = [28000 + [693,891,892,893]];    
%         shotlist = [28000 + [892:896]];    
        shotlist = [28000 + [892:898]];    
%         shotlist = [28000 + [899,900,901,902,903]];    
%         shotlist = [28000 + [903,905]];    
    case 2     
    case 3 
end
