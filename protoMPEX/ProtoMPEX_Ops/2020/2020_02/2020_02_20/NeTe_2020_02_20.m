...
switch ShotType
    case 1
        % Good shot from 2020_02_19
        shotlist = [29000 + [280]];                                                              
%         shotlist = [29000 + [286]];
%         shotlist = [29000 + [287,288]]; 
%         shotlist = [29000 + [282,284:286]]; 
        shotlist = [29000 + [288]]; 
        shotlist = [29238, 29239, 29240, 29241, 29245,29247,29250,29251,29253];
%         shotlist = [29238,29238];
        shotlist = [28000 + [158],29240]; 
        shotlist = [29240]; 
        shotlist = [29000 + [310,311,312,313],28158]; 
        shotlist = [29000 + [314,315],28158]; 
        shotlist = [29000 + [326:328]]; 
        shotlist = [29000 + [332]]; 
        shotlist = [29000 + [194]]; 
        shotlist = [29000 + [269]]; 
        shotlist = [29000 + [287]]; 
...
TimePlotStart = 4.14;
TimePlotEnd = TimePlotStart + 1.2 - 0.5;
