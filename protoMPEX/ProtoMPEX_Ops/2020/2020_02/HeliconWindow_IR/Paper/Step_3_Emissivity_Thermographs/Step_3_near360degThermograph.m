% Objective: Load IR data and create composite near 360-degree view of the
% helicon window's inner surface
...
saveData = 0;
saveFig = 1;
figureName = 'Step_3_near360degThermograph';
...
%     colormap(flipud(hot))
    ...
    % Label on color bar:
    text(2.75,4.75,'$\Delta T$[K]','Interpreter','latex','FontSize',11)
end

% set(gcf,'Position',[360.0000  105.6667  653.6667  512.3333])

if saveFig
    % Save figures:
    saveas(gcf,figureName,'tiffn')
    print(gcf,figureName,'-dsvg')
