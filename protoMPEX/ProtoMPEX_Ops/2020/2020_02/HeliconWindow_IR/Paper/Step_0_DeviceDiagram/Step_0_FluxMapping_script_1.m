% Creates schematic of Proto-MPEX and describes the various components in
% the device such as the limiter, Last Uninterrupted Flux Surface, Helicon
% window, Target an Dump etc.
