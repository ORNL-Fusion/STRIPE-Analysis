...
% Draw antenna straps:
L(1) = line(    +[90,00],[5,25],[300,300]);
L(2) = line(180 +[90,00],[5,25],[300,300]);
L(3) = line([0,360],[5,5],[300,300]);
L(4) = line([0,360],[25,25],[300,300]);
L(5) = line(-10+[240,230],[14,16],[300,300]);
