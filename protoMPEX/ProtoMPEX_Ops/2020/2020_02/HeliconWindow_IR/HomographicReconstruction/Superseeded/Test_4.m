...
% Calibration matrix:
% =========================================================================
r_star = [-0.102*1e-3,-1.92*1e-3,ff ]';
q_star = [+0         ,-Ra        ,0  ]';

M = r_star*R3' + ff*Omega*R';
G = M(1:2,1:2);
H = -M(1:2,3);
P = inv(G)*H;
...
% =========================================================================
L(1) = q_star(1) + P(1)*(Lz - q_star(3))
L(2) = q_star(2) + P(2)*(Lz - q_star(3))
