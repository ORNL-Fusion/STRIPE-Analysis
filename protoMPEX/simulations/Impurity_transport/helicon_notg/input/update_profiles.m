...
file1='profilesProtoMPEX_1.nc';
file2='profilesProtoMPEX_28950.nc'
x0 = ncread(file,'x');
z0 = ncread(file,'z');
ni0 = ncread(file,'ni');
ne0 = ncread(file,'ne');
...
ni_interp=ne_interp;
te_interp=interpn(x0,z0,te1,xx,zz);
ti_interp=ti1;
...
% 
% psi_interp=interpn(xB,zB,psi,rr1,zz1);
% 
...
netcdf.putVar(ncid,vznc,vz_interp');
