...
x=ncread('profilesPISCESRF.nc','x');
z=ncread('profilesPISCESRF.nc','z');

ne=ncread('profilesPISCESRF.nc','ne');
...
te=ncread('profilesPISCESRF.nc','te');
...
% vx=ncread('../TeX1/input/profilesPISCESRF.nc','vx');
% vx=ncread('../TeX1/input/profilesPISCESRF.nc','vy');
