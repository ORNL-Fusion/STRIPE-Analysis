...
zz=zz+3.5;
% ne_surf=double(interp1(double(z),double(ne(801,:)),zz)); %r=0.02
% te_surf=double(interp1(double(z),double(te(801,:)),zz));
% ne_surf=double(interp1(double(z),double(ne(2500,:)),zz)); %r=0.0625
% te_surf=double(interp1(double(z),double(te(2500,:)),zz));

ne_surf=double(interp1(double(z),double(ne(1600,:)),zz)); %r=0.04
te_surf=double(interp1(double(z),double(te(1600,:)),zz));
