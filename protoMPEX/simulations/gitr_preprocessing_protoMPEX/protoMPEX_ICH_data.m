...
nZ = 200;
nR = 120;
r_grid = linspace(0.0,0.1,120);
x_grid = linspace(-0.1,0.1,100);
y_grid = linspace(-0.1,0.1,110);
z_grid = linspace(-0.8+3.5,0.8+3.5,200);
...
h.EdgeColor = 'none';
colorbar
title({'PISCES Magnetic Field (r) Profile'})
xlabel('r [m]')
ylabel('z [m]')
