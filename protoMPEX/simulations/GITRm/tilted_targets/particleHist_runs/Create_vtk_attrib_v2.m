...
%% ===== Remove extra space beyond bounding box =====
ax.LooseInset = [0 0 0 0];
ax.Position   = [0.08 0.08 0.84 0.84];  % tight framing
...
close(v);
fprintf('Night-mode MP4 saved (Mac compatible, tight box, reduced particles).\n');