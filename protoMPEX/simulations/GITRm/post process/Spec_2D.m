...
source_strength = 1e+20 ; % # 200882
n_Spec = 1;

%% 4) Load GITRm spec data
path1 = "../tilted_targets/45_degrees/MPEX_runs_test/";
...
figure; imagesc(gridr_2d,gridz_2d,data_trim)
...
volume = 2*pi * dz .* (0.5 * dr);   % [nZ × 1]
volume = repmat(volume, 1, length(r1));
